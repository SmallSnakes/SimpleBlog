!
	function (t, e) {
		...
		function (t) {
			...
			function f(t, e, n) {
				if (t && e) if (t.forEach && t.forEach === ep) t.forEach(e, n);
			...
			function p(t, e, n) {
				if (t && e) {
					if (t.map && t.map === rp) return t.map(e, n);
			...
			function v(t, e, n) {
				if (t && e) {
					if (t.filter && t.filter === np) return t.filter(e, n);
			...
			function de(t, e, n, i, r, a) {
				...
				if (1 === e) {
					var l = Math.round(Math.log((1 << s) - 1 & ~r) / _p);
					return t[n][l]
				}
				for (var u = i | 1 << n,
					h = n + 1; i & 1 << h;) h++;
			...
			function ge(t, e, n, i, r) {
				if (e.getBoundingClientRect && Kf.domSupported && !ye(e)) {
					var a = e[xp] || (e[xp] = {}),
						o = ve(e, a),
						s = me(o, a, r);
					if (s) return s(t, n, i),
			...
			function _e(t, e, n, i) {
				return n = n || {},
					i || !Kf.canvasSupported ? xe(t, e, n) : Kf.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (n.zrX = e.layerX, n.zrY = e.layerY) : null != e.offsetX ? (n.zrX = e.offsetX, n.zrY = e.offsetY) : xe(t, e, n),
					n
			}
			function xe(t, e, n) {
				if (Kf.domSupported && t.getBoundingClientRect) {
					var i = e.clientX,
						r = e.clientY;
					if (ye(t)) {
					...
					if (ge(Mp, t, i, r)) return n.zrX = Mp[0],
						void (n.zrY = Mp[1])
				}
				n.zrX = n.zrY = 0
			}
			...
			function be(t, e, n) {
				...
				var o = e.button;
				return null == e.which && void 0 !== o && Sp.test(e.type) && (e.which = 1 & o ? 1 : 2 & o ? 3 : 4 & o ? 2 : 0),
					e
			}
			function Se(t, e, n, i) {
				bp ? t.addEventListener(e, n, i) : t.attachEvent("on" + e, n)
			}
			function Me(t, e, n, i) {
				bp ? t.removeEventListener(e, n, i) : t.detachEvent("on" + e, n)
			}
			function Ie(t) {
				var e = t[1][0] - t[0][0],
					n = t[1][1] - t[0][1];
			...
			function ln(t, e) {
				return t = Je(t),
					t && null != e ? (t[3] = Ye(e), un(t, "rgba")) : void 0
			}
			function un(t, e) {
				if (t && t.length) {
					var n = t[0] + "," + t[1] + "," + t[2];
			...
			function gn(t, e, n) {
				...
				if (i !== r) {
					var a = i > r;
					if (a) t.length = r;
					else for (var o = i; r > o; o++) t.push(1 === n ? e[o] : Qp.call(e[o]))
				}
			...
			function _n(t) {
				if (d(t)) {
					var e = t.length;
					if (d(t[0])) {
						for (var n = [], i = 0; e > i; i++) n.push(Qp.call(t[i]));
						return n
					}
					return Qp.call(t)
				}
			...
			function Hn(t, e, n, i, r) {
				if (t) {
					if ("string" == typeof t) {
						...
						return a ? (e = a.image, !Wn(e) && a.pending.push(o)) : (e = new Image, e.onload = e.onerror = Gn, Tg.put(t, e.__cachedImgObj = {
							image: e,
							pending: [o]
			...
			function Xn(t, e) {
				...
				return Dg > Ag && (Dg = 0, Cg = {}),
					Dg++ ,
					Cg[n] = r,
					r
			}
			function Yn(t, e, n, i, r, a, o, s) {
				return o ? qn(t, e, n, i, r, a, o, s) : Un(t, e, n, i, r, a, s)
			}
			...
			function ri(t, e) {
				...
				for (var i, r = kg.lastIndex = 0; null != (i = kg.exec(t));) {
					var a = i.index;
			...
			function ui(t) {
				if (t) {
					...
					var e = t.textAlign;
					"middle" === e && (e = "center"),
						t.textAlign = null == e || Bg[e] ? e : "left";
					var n = t.textVerticalAlign || t.textBaseline;
					"center" === n && (n = "middle"),
						t.textVerticalAlign = null == n || Eg[n] ? n : "top";
					var i = t.textPadding;
			...
			function ci(t, e, n, i, r, a) {
				var o, s = vi(i),
					l = !1,
					u = e.__attrCachedBy === vg.PLAIN_TEXT;
				a !== mg ? (a && (o = a.style, l = !s && u && o), e.__attrCachedBy = s ? vg.NONE : vg.PLAIN_TEXT) : u && (e.__attrCachedBy = vg.NONE);
				var h = i.font || Og;
				l && h === (o.font || Og) || (e.font = h);
				...
				for (var A = 0; A < zg.length; A++) {
					var k = zg[A],
						P = k[0],
						L = k[1],
						O = i[P];
					l && O === o[P] || (e[L] = gg(e, L, O || k[2]))
				}
				I += m / 2;
			...
			function _i(t, e, n, i) {
				...
				if (i) {
					...
					if (l instanceof Array) r = i.x + Si(l[0], i.width),
						...
						var u = e && e.calculateTextPosition ? e.calculateTextPosition(Rg, n, i) : Kn(Rg, n, i);
						r = u.x,
							a = u.y,
							o = o || u.textAlign,
			...
			function Ti(t) {
				...
				this.style = new _g(t.style, this),
					this._rect = null,
			...
			function ki(t, e, n) {
				return Yg.copy(t.getBoundingRect()),
					t.transform && Yg.applyTransform(t.transform),
					Ug.width = e,
					Ug.height = n,
					!Yg.intersect(Ug)
			}
			...
			function Hi(t, e) {
				var n = e.domHandlers;
				Kf.pointerEventsSupported ? f($g.pointer,
					function (i) {
						Wi(e, i,
							function (e) {
								n[i].call(t, e)
							})
					}) : (Kf.touchEventsSupported && f($g.touch,
						function (i) {
							Wi(e, i,
								function (r) {
									n[i].call(t, r),
			...
			function Gi(t, e) {
				...
				Kf.pointerEventsSupported ? f(Qg.pointer, n) : Kf.touchEventsSupported || f(Qg.mouse, n)
			}
			function Wi(t, e, n, i) {
				t.mounted[e] = n,
					t.listenerOpts[e] = i,
			...
			function Yi(t, e) {
				if (t._mayPointerCapture = null, Kg && t._pointerCapturing ^ e) {
			...
			function qi(t, e) {
				yp.call(this),
					this.dom = t,
					this.painterRoot = e,
					this._localHandlerScope = new Ui(t, tv),
					Kg && (this._globalHandlerScope = new Ui(document, ev)),
			...
			function Zi(t) {
				if (t) t.dispose();
					...
					for (var e in av) av.hasOwnProperty(e) && av[e].dispose();
					av = {}
				}
				return this
			}
			...
			function er(t) {
				return !hv(t) || cv(t) || t instanceof Date ? t : t.value
			}
			function nr(t) {
					...
					uv(t,
						function (t, n) {
							var i = t.exist,
								...
								a = t.keyInfo;
							if (hv(r)) {
								if (a.name = null != r.name ? r.name + "" : i ? i.name : dv + n, i) a.id = i.id;
			...
			function lr() {
				var t = "__\x00ec_inner_" + pv++ + "_" + Math.random().toFixed(5);
				return function (e) {
					return e[t] || (e[t] = {})
				}
			}
			...
			function fr(t) {
				return "auto" === t ? Kf.domSupported ? "html" : "richText" : t || "html"
			}
			function pr(t) {
				var e = {
					main: "",
				...
				return t && (t = t.split(gv), e.main = t[0] || "", e.sub = t[1] || ""),
					e
			}
			function gr(t) {
			...
			function mr(t) {
				var e = ["__\x00is_clz", mv++, Math.random().toFixed(3)].join("_");
				t.prototype[e] = !0,
			...
			function xr(t, e) {
				...
				if (t.registerClass = function (t, e) {
					...
					t.getClass = function (t, e, n) {
						var r = i[t];
						if (r && r[vv] && (r = e ? r[e] : null), n && !r) throw new Error(e ? "Component " + t + "." + (e || "") + " not exists. Load it first." : t + ".type should be specified.");
						return r
					},
				...
				if (wr(h) && wr(c)) if (wr(s)) a[0] = 0;
					...
					if (wr(g)) {
						...
						var y = Mv(g),
							_ = h * s + 1.5 * o * (- c + y),
							x = h * s + 1.5 * o * (- c - y);
						_ = 0 > _ ? -Sv(- _, Dv) : Sv(_, Dv),
							x = 0 > x ? -Sv(- x, Dv) : Sv(x, Dv);
						var p = (- s - (_ + x)) / (3 * o);
						p >= 0 && 1 >= p && (a[f++] = p)
					} else {
						var w = (2 * h * s - 3 * o * c) / (2 * Mv(h * h * h)),
							b = Math.acos(w) / 3,
							S = Mv(h),
							M = Math.cos(b),
							p = (- s - 2 * S * M) / (3 * o),
							m = (- s + S * (M + Cv * Math.sin(b))) / (3 * o),
							I = (- s + S * (M - Cv * Math.sin(b))) / (3 * o);
						p >= 0 && 1 >= p && (a[f++] = p),
							m >= 0 && 1 >= m && (a[f++] = m),
							I >= 0 && 1 >= I && (a[f++] = I)
					}
			...
			function Dr(t, e, n, i, r, a, o, s, l, u, h) {
				...
				Av[0] = l,
					Av[1] = u;
				for (var y = 0; 1 > y; y += .05) kv[0] = Sr(t, n, r, o, y),
					kv[1] = Sr(e, i, a, s, y),
					p = gp(Av, kv),
					m > p && (c = y, m = p);
				m = 1 / 0;
				for (var _ = 0; 32 > _ && !(Tv > v); _++) d = c - v,
					f = c + v,
					kv[0] = Sr(t, n, r, o, d),
					kv[1] = Sr(e, i, a, s, d),
					p = gp(kv, Av),
					d >= 0 && m > p ? (c = d, m = p) : (Pv[0] = Sr(t, n, r, o, f), Pv[1] = Sr(e, i, a, s, f), g = gp(Pv, Av), 1 >= f && m > g ? (c = f, m = g) : v *= .5);
			...
			function Rr(t, e, n, i, r, a, o, s, l, u) {
				...
				for (l[0] = 1 / 0, l[1] = 1 / 0, u[0] = -1 / 0, u[1] = -1 / 0, h = 0; f > h; h++) {
					var p = d(t, n, r, o, Vv[h]);
					l[0] = Lv(p, l[0]),
						u[0] = Ov(p, u[0])
				}
				for (f = c(e, i, a, s, Hv), h = 0; f > h; h++) {
					var g = d(e, i, a, s, Hv[h]);
					l[1] = Lv(g, l[1]),
						u[1] = Ov(g, u[1])
				}
				l[0] = Lv(t, l[0]),
			...
			function Fr(t, e, n, i, r, a, o, s, l) {
				var u = oe,
					h = se,
					c = Math.abs(r - a);
				if (1e-4 > c % zv && c > 1e-4) return s[0] = t - n,
					s[1] = e - i,
					l[0] = t + n,
					void (l[1] = e + i);
				if (Rv[0] = Ev(r) * n + t, Rv[1] = Bv(r) * i + e, Nv[0] = Ev(a) * n + t, Nv[1] = Bv(a) * i + e, u(s, Rv, Nv), h(l, Rv, Nv), r %= zv, 0 > r && (r += zv), a %= zv, 0 > a && (a += zv), r > a && !o ? a += zv : a > r && o && (r += zv), o) {
					var d = a;
					a = r,
						r = d
				}
				for (var f = 0; a > f; f += Math.PI / 2) f > r && (Fv[0] = Ev(f) * n + t, Fv[1] = Bv(f) * i + e, u(s, Fv, s), h(l, Fv, l))
			}
			...
			function jr(t, e, n, i, r, a, o, s, l, u) {
				...
				for (var c, d, f = 0,
					...
					var v = om[g],
						m = 0 === v || 1 === v ? .5 : 1,
						y = Sr(t, n, r, o, v);
					l > y || (0 > p && (p = Tr(e, i, a, s, sm), sm[1] < sm[0] && p > 1 && qr(), c = Sr(e, i, a, s, sm[0]), p > 1 && (d = Sr(e, i, a, s, sm[1]))), f += 2 === p ? v < sm[0] ? e > c ? m : -m : v < sm[1] ? c > d ? m : -m : d > s ? m : -m : v < sm[0] ? e > c ? m : -m : c > s ? m : -m)
				}
				return f
			}
			function Zr(t, e, n, i, r, a, o, s) {
				...
				if (u >= 0 && 1 >= u) {
					for (var h = 0,
						...
						var f = 0 === om[d] || 1 === om[d] ? .5 : 1,
							p = Ar(t, n, r, om[d]);
						o > p || (h += om[d] < u ? e > c ? f : -f : c > a ? f : -f)
					}
					return h
				}
				var f = 0 === om[0] || 1 === om[0] ? .5 : 1,
					p = Ar(t, n, r, om[0]);
				...
				for (var c = 0,
					...
					if (f + t > o) {
						var p = Math.atan2(s, f),
							h = a ? 1 : -1;
						0 > p && (p = rm + p),
							(p >= i && r >= p || p + rm >= i && r >= p + rm) && (p > Math.PI / 2 && p < 1.5 * Math.PI && (h = -h), c += h)
					}
				}
				return c
			}
			function $r(t, e, n, i, r) {
				for (var a = 0,
					...
					h = 0; h < t.length;) {
					var c = t[h++];
					switch (c === im.M && h > 1 && (n || (a += Yr(o, s, l, u, i, r))), 1 === h && (o = t[h], s = t[h + 1], l = o, u = s), c) {
						case im.M:
							l = t[h++],
								u = t[h++],
								o = l,
				...
				return n || Ur(s, u) || (a += Yr(o, s, l, u, i, r) || 0),
					0 !== a
			}
			function Qr(t, e, n) {
				return $r(t, 0, !1, e, n)
			...
			function ea(t, e, n, i, r, a, o, s, l, u, h) {
				var c = l * (_m / 180),
					d = ym(c) * (t - n) / 2 + mm(c) * (e - i) / 2,
					f = -1 * mm(c) * (t - n) / 2 + ym(c) * (e - i) / 2,
					p = d * d / (o * o) + f * f / (s * s);
				p > 1 && (o *= vm(p), s *= vm(p));
				var g = (r === a ? -1 : 1) * vm((o * o * s * s - o * o * f * f - s * s * d * d) / (o * o * f * f + s * s * d * d)) || 0,
					v = g * o * f / s,
					m = g * -s * d / o,
					y = (t + n) / 2 + ym(c) * v - mm(c) * m,
					_ = (e + i) / 2 + mm(c) * v + ym(c) * m,
					x = bm([1, 0], [(d - v) / o, (f - m) / s]),
					w = [(d - v) / o, (f - m) / s],
					b = [(- 1 * d - v) / o, (- 1 * f - m) / s],
					S = bm(w, b);
				wm(w, b) <= -1 && (S = _m),
			...
			function na(t) {
				...
				for (var e, n = 0,
					...
					o = new tm,
					s = tm.CMD,
					l = t.match(Sm), u = 0; u < l.length; u++) {
					for (var h, c = l[u], d = c.charAt(0), f = c.match(Mm) || [], p = f.length, g = 0; p > g; g++) f[g] = parseFloat(f[g]);
					for (var v = 0; p > v;) {
			...
			function la(t, e, n) {
				...
				if (i && i.length >= 2) {
					if (r && "spline" !== r) {
						var a = Lm(i, r, n, e.smoothConstraint);
			...
			function ua(t, e, n) {
				if (e) {
					...
					t.x1 = i,
						...
						t.y2 = o;
					var s = n && n.lineWidth;
					s && (Em(2 * i) === Em(2 * r) && (t.x1 = t.x2 = ca(i, s, !0)), Em(2 * a) === Em(2 * o) && (t.y1 = t.y2 = ca(a, s, !0)))
				}
			}
			function ha(t, e, n) {
				if (e) {
			...
			function ca(t, e, n) {
				if (!e) return t;
				var i = Em(2 * t);
				return (i + Em(e)) % 2 === 0 ? i / 2 : (i + (n ? 1 : -1)) / 2
			}
			function da(t, e, n) {
				var i = t.cpx2,
					r = t.cpy2;
			...
			function Ia(t) {
				...
				var e = oy.get(t);
				return e || (e = nn(t, -.1), 1e4 > sy && (oy.set(t, e), sy++)),
					e
			}
			function Ta(t) {
			...
			function Aa(t) {
				...
				if (e && (t.__highlighted = !1, !t.isGroup)) if ("layer" === e) t.__zr && t.__zr.removeHover(t);
					...
					null != r && t.z2 - r === $m && (t.z2 = r)
				}
			}
			function ka(t, e, n) {
				var i, r = ty,
					a = ty;
				t.__highlighted && (r = Jm, i = !0),
					e(t, n),
					t.__highlighted && (a = Jm, i = !0),
			...
			function Ha(t, e, n, i, r, a, o) {
				...
				var f = c ? s : null,
					p = d ? A(l ? l.getFormattedLabel(u, "emphasis", null, h) : null, s) : null; (null != f || null != p) && (Wa(t, n, a, r), Wa(e, i, o, r, !0)),
						t.text = f,
						e.text = p
			}
			function Ga(t, e, n) {
			...
			function no(t, e, n) {
				return e && !d(e) && (e = Ep.getLocalTransform(e)),
					n && (e = Fe([], e)),
					ae([], t, e)
			}
			function io(t, e, n) {
			...
			function oo(t, e) {
				var n = jm(t.x, e.x),
					i = Zm(t.x + t.width, e.x + e.width),
					r = jm(t.y, e.y),
					a = Zm(t.y + t.height, e.y + e.height);
				return i >= n && a >= r ? {
					x: n,
					y: r,
					width: i - n,
			...
			function go(t, e) {
				var n = py(t).getParent;
				return n ? n.call(t, e) : t.parentModel
			}
			function vo(t) {
				return [t || "", gy++, Math.random().toFixed(5)].join("_")
			}
			function mo(t) {
				var e = {};
			...
			function Vo(t, e, n) {
				...
				for (var r = e[0].$vars || [], a = 0; a < r.length; a++) {
					var o = Sy[a];
					t = t.replace(My(o), My(o, 0))
				}
				for (var s = 0; i > s; s++) for (var l = 0; l < r.length; l++) {
					var u = e[s][r[l]];
					t = t.replace(My(Sy[l], s), n ? Fo(u) : u)
				}
				return t
			}
			function Ho(t, e, n) {
			...
			function Jo(t) {
				var e = [];
				return f(Oy.getClassesByMainType(t),
					function (t) {
			...
			function es(t) {
				this.fromDataset = t.fromDataset,
					this.data = t.data || (t.sourceFormat === Hy ? {} : []),
					this.sourceFormat = t.sourceFormat || Gy,
					this.seriesLayoutBy = t.seriesLayoutBy || Xy,
			...
			function os(t, e, n, i, r) {
				...
				var a, o;
				if (e === Fy) "auto" === i || null == i ? ls(function (t) {
					null != t && "-" !== t && (b(t) ? null == o && (o = 1) : o = 0)
				},
					n, t, 10) : o = i ? 1 : 0,
					r || 1 !== o || (r = [], ls(function (t, e) {
						r[e] = null != t ? t : ""
					},
						n, t)),
					a = r ? r.length : n === Yy ? t.length : t[0] ? t[0].length : null;
				else if (e === Vy) r || (r = us(t));
				else if (e === Hy) r || (r = [], f(t,
					function (t, e) {
						r.push(e)
					}));
				else if (e === Ny) {
			...
			function ls(t, e, n, i) {
				if (null == i && (i = 1 / 0), e === Yy) for (var r = 0; r < n.length && i > r; r++) t(n[r] ? n[r][0] : null, r);
			...
			function cs(t, e, n) {
				...
				var a, o = e.sourceFormat,
					s = e.dimensionsDefine; (o === Vy || o === Hy) && f(s,
						function (t, e) {
				...
				var l = function () {
					...
					for (var i = {},
						...
						l.push(c);
						var d = c === Uy.Not;
						if (d && null == i.v && u !== a && (i.v = u), (null == i.n || i.n === i.v || !d && l[i.n] === Uy.Not) && (i.n = u), t(i) && l[i.n] !== Uy.Not) return i;
						d || (c === Uy.Might && null == r.v && u !== a && (r.v = u), (null == r.n || r.n === r.v) && (r.n = u))
					}
			...
			function ps(t, e, n, i, r, a) {
				function o(t) {
					var e = b(t);
					return null != t && isFinite(t) && "" !== t ? e ? Uy.Might : Uy.Not : e && "-" !== t ? Uy.Must : void 0
				}
				var s, l = 5;
				if (I(t)) return Uy.Not;
				var u, h;
				if (i) {
					var c = i[a];
					S(c) ? (u = c.name, h = c.type) : b(c) && (u = c)
				}
				if (null != h) return "ordinal" === h ? Uy.Must : Uy.Not;
				if (e === Fy) if (n === Yy) {
					...
					if (!u) return Uy.Not;
					var d = t[u];
					if (!d || I(d)) return Uy.Not;
					for (var f = 0; f < d.length && l > f; f++) if (null != (s = o(d[f]))) return s
				} else if (e === Ny) for (var f = 0; f < t.length && l > f; f++) {
					var g = t[f],
						v = er(g);
					if (!x(v)) return Uy.Not;
			...
			function vs(t, e) {
				...
				f(e,
					function (e, a) {
						"colorLayer" === a && n || Oy.hasClass(a) || ("object" == typeof e ? t[a] = t[a] ? r(t[a], e, !1) : i(e) : null == t[a] && (t[a] = e))
					})
			}
			function ms(t) {
				t = t,
			...
			function _s(t, e, n) {
				var i = e.type ? e.type : n ? n.subType : Oy.determineSubType(t, e);
				return i
			}
			function xs(t, e) {
						...
						function (e, n) {
							if (null != e) {
								...
								if (Oy.hasClass(n)) {
									...
									t[n] = t_(r,
										function (t) {
											return t.option && t.exist ? e_(t.exist, t.option, !0) : t.exist || t.option
										})
								} else t[n] = e_(i, e, !0)
							}
						})
			...
			function Es(t) {
				if (r_(t)) {
					...
					if (e && e.data) for (var s = e.data,
						o = 0; o < s.length; o++) Bs(s[o]);
					var n = t.markLine;
					if (n && n.data) for (var l = n.data,
						o = 0; o < l.length; o++) x(l[o]) ? (Bs(l[o][0]), Bs(l[o][1])) : Bs(l[o]);
					"gauge" === t.type ? (Os(t, "axisLabel"), Os(t, "title"), Os(t, "detail")) : "treemap" === t.type ? (Ps(t.breadcrumb, "itemStyle"), f(t.levels,
						function (t) {
							Ls(t)
			...
			function Gs(t, e) {
				...
				var r = d_[i === Fy ? i + "_" + t.seriesLayoutBy : i];
				o(this, r)
			}
			function Ws() {
			...
			function El(t) {
				for (var e = B(t).split(Z_), n = [], i = 0; i < e.length; i += 2) {
			...
			function zl(t, e, n, i) {
				var r = e.__inheritedStyle || {},
					a = "text" === e.type;
				if (1 === t.nodeType && (Nl(t, e), o(r, Fl(t)), !i)) for (var s in Q_) if (Q_.hasOwnProperty(s)) {
					var l = t.getAttribute(s);
					null != l && (r[Q_[s]] = l)
				}
				var u = a ? "textFill" : "fill",
					h = a ? "textStroke" : "stroke";
				e.style = e.style || new _g;
				var c = e.style;
				null != r.fill && c.set(u, Rl(r.fill, n)),
					...
					r.lineDash && (e.style.lineDash = B(r.lineDash).split(Z_)),
					c[h] && "none" !== c[h] && (e[h] = !0),
					e.__inheritedStyle = r
			}
			function Rl(t, e) {
				var n = e && t && t.match(J_);
				if (n) {
					var i = B(n[1]),
						r = e[i];
					return r
			...
			function Fl(t) {
				...
				var i = {};
				ex.lastIndex = 0;
				for (var r; null != (r = ex.exec(e));) i[r[1]] = r[2];
				for (var a in Q_) Q_.hasOwnProperty(a) && null != i[a] && (n[Q_[a]] = i[a]);
				return n
			}
			function Vl(t, e, n) {
				var i = e / t.width,
			...
			function Hl(t, e) {
				...
				(e || !this._disposed) && (n = n && n.toLowerCase(), yp.prototype[t].call(this, n, i, r))
				}
			}
			function Gl() {
				yp.call(this)
			...
			function Wl(t, e, n) {
				...
				Bn(Rx, r),
					Bn(Bx, r),
					this._scheduler = new vl(this, s, Bx, Rx),
					yp.call(this, this._ecEventProcessor = new lu),
					this._messageCenter = new Gl,
					this._initEvents(),
			...
			function Ul(t, e, n, i, r) {
				...
				var o = t._model;
				if (!i) return void ox(t._componentsViews.concat(t._chartsViews), a);
				var s = {};
				s[i + "Id"] = n[i + "Id"],
					s[i + "Index"] = n[i + "Index"],
					s[i + "Name"] = n[i + "Name"];
			...
			function jl(t, e) {
				...
				ox(h,
					...
					this),
					"none" === u || g || l || (this[Cx] ? (Yl(this), kx.update.call(this, t), this[Cx] = !1) : kx[u].call(this, t)),
					d = c ? {
						type: a.event || n,
						escapeConnect: i,
						batch: f
			...
			function $l(t, e) {
				t.on("rendered",
					function () {
						e.trigger("rendered"),
							!t.animation.isFinished() || e[Cx] || e._scheduler.unfinished || e._pendingActions.length || e.trigger("finished")
					})
			}
			function Ql(t, e, n, i) {
				function r(t) {
					...
					if (!r) {
						var h = ux(t.type),
							c = a ? w_.getClass(h.main, h.sub) : ul.getClass(h.sub);
						r = new c,
							r.init(n, u),
							s[e] = r,
							o.push(r),
			...
			function ru(t, e) {
				...
				i.traverse(function () {
					...
					r > e.get("hoverLayerThreshold") && !Kf.node && e.eachSeries(function (e) {
			...
			function fu(t) {
				"string" == typeof t ? t = Vx[t] : t instanceof Wl || (t = pu(t)),
			...
			function xu(t, e, n) {
				...
				var i = lx(t) ? t.type : [t, t = {
					event: e
				}][0];
				t.event = (t.event || i).toLowerCase(),
					e = t.event,
					ax(Dx.test(i) && Dx.test(e)),
					Lx[i] || (Lx[i] = {
						action: n,
						actionInfo: t
					}),
			...
			function Lu(t, e, n) {
				ix.registerMap(t, e, n)
			}
			function Ou(t) {
				var e = ix.retrieveMap(t);
				return e && e[0] && {
					geoJson: e[0].geoJSON,
			...
			function Gu(t) {
				return t._rawCount > 65535 ? Jx : ew
			}
			function Wu(t) {
				var e = t.constructor;
			...
			function Xu(t, e) {
				f(nw.concat(e.__wrappedMethods || []),
					function (n) {
						e.hasOwnProperty(n) && (t[n] = e[n])
					}),
				...
				f(e,
					function (n, i) {
						var r = t._dimensionInfos[i],
							a = r.ordinalMeta;
						if (a) {
							n = e[i] = new tw(a.categories.length);
							for (var o = 0; o < n.length; o++) n[o] = Kx;
			...
			function Ku(t, e) {
				var n = t._idList[e];
				return null == n && (n = qu(t, t._idDimIdx, e)),
					null == n && (n = $x + e),
					n
			}
			function $u(t) {
			...
			function Qu(t, e) {
				var n = t.dimensions,
					i = new rw(p(n, t.getDimensionInfo, t), t.hostModel);
				Xu(i, t);
			...
			function eh(t, e, n) {
				function r(t, e, n) {
					null != qx.get(e) ? t.otherDims[e] = n : (t.coordDim = e, t.coordDimIndex = n, u.set(e, !0))
				}
				...
				for (var M = _ || "value",
					I = 0; c > I; I++) {
					var v = h[I] = h[I] || new Hu,
						T = v.coordDim;
					null == T && (v.coordDim = ih(M, u, w), v.coordDimIndex = 0, (!_ || 0 >= x) && (v.isExtraCoord = !0), x--),
						null == v.name && (v.name = ih(v.coordDim, l)),
						null != v.type || fs(e, I, v.name) !== Uy.Must && (!v.isExtraCoord || null == v.otherDims.itemName && null == v.otherDims.seriesName) || (v.type = "ordinal")
				}
				return h
			}
			function nh(t, e, n, i) {
			...
			function mh(t, e, n, i) {
				...
				var s = r.intervalPrecision = yh(o),
					l = r.niceTickExtent = [dw(Math.ceil(t[0] / o) * o, s), dw(Math.floor(t[1] / o) * o, s)];
				return xh(l, t),
					r
			}
			function yh(t) {
			...
			function wh(t) {
				return t.get("stack") || gw + t.seriesIndex
			}
			function bh(t) {
			...
			function Oh(t, e) {
				var n, i, r, a = t.type,
					...
					u = null != s,
					h = t.getExtent();
				"ordinal" === a ? n = e.getCategories().length : (i = e.get("boundaryGap"), x(i) || (i = [i || 0, i || 0]), "boolean" == typeof i[0] && (i = [0, 0]), i[0] = wo(i[0], 1), i[1] = wo(i[1], 1), r = h[1] - h[0] || Math.abs(h[0])),
			...
			function zh(t, e) {
				if (e = e || t.get("type")) switch (e) {
					...
					case "value":
						return new pw;
					default:
						return (fh.getClass(e) || pw).create(t)
				}
			}
			function Rh(t) {
			...
			function Wh(t) {
				return "category" === t.type && 0 === Gh(t.getLabelModel())
			}
			function Xh(t, e) {
				if ("image" !== this.type) {
					var n = this.style,
			...
			function Yh(t, e, n, i, r, a, o) {
				...
				return l = 0 === t.indexOf("image://") ? _a(t.slice(8), new Tn(e, n, i, r), o ? "center" : "cover") : 0 === t.indexOf("path://") ? ya(t.slice(7), {},
					new Tn(e, n, i, r), o ? "center" : "cover") : new Uw({
						shape: {
							symbolType: t,
							x: e,
							y: n,
			...
			function qh(t, e) {
				var n = e;
				fo.isInstance(e) || (n = new fo(e), c(n, Nw));
				var i = zh(n);
			...
			function Kh(t, e, n) {
				...
				for (var a = 1; a < t.length; a++) {
					var o = t[a];
					i += Yr(r[0], r[1], o[0], o[1], e, n),
						r = o
				}
				var s = t[0];
				return Zh(r[0], s[0]) && Zh(r[1], s[1]) || (i += Yr(r[0], r[1], s[0], s[1], e, n)),
					0 !== i
			}
			function $h(t, e, n) {
			...
			function Qh(t) {
				...
				for (var n = t.features,
					i = 0; i < n.length; i++) for (var r = n[i], a = r.geometry, o = a.coordinates, s = a.encodeOffsets, l = 0; l < o.length; l++) {
						var u = o[l];
						if ("Polygon" === a.type) o[l] = Jh(u, s[l], e);
			...
			function rc(t, e) {
				...
				if (r) return r;
				var a, o;
				if ((!e.get("show") || t.scale.isBlank()) && (a = []), w(i)) a = fc(t, i, !0);
				else if ("auto" === i) {
			...
			function uc(t) {
				var e = $w(t).autoInterval;
				return null != e ? e : $w(t).autoInterval = t.calculateCategoryInterval()
			}
			function hc(t) {
				var e = cc(t),
					n = Nh(t),
			...
			function wc(t, e, n, i) {
				...
				if (l) {
					if (null != u) bc(o[u]) && (a = o[u]);
					else for (var h in o) if (o.hasOwnProperty(h) && bc(o[h]) && !i[r(o[h])]) {
						a = o[h];
						break
					}
					a && (i[r(a)] = !0)
			...
			function Nc(t, e, n) {
				...
				e.add(f),
					...
					t.get("silent") || (f.on("mousedown", Ib), f.on("mousemove", Ib))
			}
			function Fc(t, e, n) {
				...
				yb[0] = e,
					yb[1] = n;
				for (var u = yb[i], h = yb[1 - i], c = u - s, d = u + s, f = 0, p = a.length / 2; p > f; f++) {
					var g = 2 * f,
						v = a[g + i],
						m = a[g + r];
			...
			function Xc(t, e, n, i) {
				...
				return Ao(o - Tb / 2) ? (a = l ? "bottom" : "top", r = "center") : Ao(o - 1.5 * Tb) ? (a = l ? "top" : "bottom", r = "center") : (a = "middle", r = 1.5 * Tb > o && o > Tb / 2 ? l ? "left" : "right" : l ? "right" : "left"),
				{
					rotation: o,
					textAlign: r,
					textVerticalAlign: a
			...
			function Yc(t, e, n) {
				if (!Wh(t.axis)) {
					...
					var a = e[0],
						...
						c = n[n.length - 1],
						d = n[n.length - 2];
					i === !1 ? (Uc(a), Uc(u)) : qc(a, o) && (i ? (Uc(o), Uc(h)) : (Uc(a), Uc(u))),
						r === !1 ? (Uc(s), Uc(c)) : qc(l, s) && (r ? (Uc(l), Uc(d)) : (Uc(s), Uc(c)))
				}
			}
			function Uc(t) {
				t && (t.ignore = !0)
			...
			function $c(t, e, n) {
				...
				if (r.get("show") && !i.scale.isBlank()) {
					...
					if (a.length) for (var o = r.getModel("lineStyle"), l = n.tickDirection * r.get("length"), u = s(o.getLineStyle(), s(e.getModel("axisTick").getLineStyle(), {
						stroke: e.get("axisLine.lineStyle.color")
					})), h = 0; h < a.length; h++) for (var c = Zc(a[h], t._transform, l, u, "minorticks_" + h), d = 0; d < c.length; d++) t.group.add(c[d])
				}
			}
			function Qc(t, e, n) {
				var i = e.axis,
				...
				if (r && !i.scale.isBlank()) {
					var a = e.getModel("axisLabel"),
						o = a.get("margin"),
						s = i.getViewLabels(),
						l = (D(n.labelRotate, a.get("rotate")) || 0) * Tb / 180,
						u = kb(n.rotation, l, n.labelDirection),
					...
					return f(s,
						function (r, s) {
							...
							Wa(x.style, v, {
								...
								p && (x.eventData = Ab(e), x.eventData.targetType = "axisLabel", x.eventData.value = g),
								t._dumbGroup.add(x),
								x.updateTransform(),
								c.push(x),
								t.group.add(x),
				...
				Lb(n.getCoordinateSystems(),
					function (n) {
						...
						if (n.axisPointerEnabled) {
							...
							if (Lb(n.getAxes(), Ob(s, !1, null)), n.getTooltipAxes && i && c.get("show")) {
								var d = "axis" === c.get("trigger"),
									f = "cross" === c.get("axisPointer.type"),
									p = n.getTooltipAxes(c.get("axisPointer.axis")); (d || f) && Lb(p.baseAxes, Ob(s, f ? "cross" : !0, d)),
										f && Lb(p.otherAxes, Ob(s, "cross", !1))
							}
						}
					})
			}
			function ed(t, e, n, r, a, o) {
				var l = e.getModel("axisPointer"),
					u = {};
				Lb(["type", "snap", "lineStyle", "shadowStyle", "label", "animation", "animationDurationUpdate", "animationEasingUpdate", "z"],
					function (t) {
						u[t] = i(l.get(t))
					}),
			...
			function nd(t, e) {
				e.eachSeries(function (e) {
					...
					n && "none" !== i && i !== !1 && "item" !== i && r !== !1 && e.get("axisPointer.show", !0) !== !1 && Lb(t.coordSysAxesInfo[ud(n.model)],
						function (t) {
							var i = t.axis;
			...
			function id(t, e) {
				for (var n = e.model,
					...
					r = 0; r < t.length; r++) {
					var a = t[r] || {};
					if (rd(a[i + "AxisId"], n.id) || rd(a[i + "AxisIndex"], n.componentIndex) || rd(a[i + "AxisName"], n.name)) return r
				}
			}
			function rd(t, e) {
			...
			function hd(t, e, n, i, r, a) {
				var o = Bb.getAxisPointerClass(t.axisPointerClass);
				if (o) {
					var s = sd(e);
				...
				for (var c = 0,
					...
					if (d === n) t[a > 0 ? "moveTo" : "lineTo"](p[0], p[1]);
						...
						Kb(Qb, g),
							...
							Kb(Jb, p),
							Jb[v] = p[v] - m,
							t.bezierCurveTo(Qb[0], Qb[1], Jb[0], Jb[1], p[0], p[1])
			...
			function Bd(t, e, n) {
				...
				for (var i = [], r = 0, a = e.count(); a > r; r++) i.push(Id(n, t, e, r));
				return i
			}
			function Ed(t, e, n) {
			...
			function Nd(t, e) {
				...
				isNaN(i) && (i = 0);
				for (var r = e.count(), a = Math.max(1, Math.round(r / 5)), o = 0; r > o; o += a) if (1.5 * gd.getSymbolSize(e, o)[t.isHorizontal() ? 1 : 0] > i) return !1;
				return !0
			}
			function Fd(t, e, n) {
				if ("cartesian2d" === t.type) {
			...
			function Hd(t, e, n, i) {
				...
				i.dispatchAction({
					...
					r.each(function (t) {
						Gd(r.getItemGraphicEl(t), r.getItemLayout(t), e.isSelected(r.getName(t)), s, n)
					})
			}
			...
			function Yd(t, e, n, i, r, a, o, s) {
				for (var l = [], u = [], h = Number.MAX_VALUE, c = -Number.MAX_VALUE, d = 0; d < t.length; d++) Ud(t[d]) || (t[d].x < e ? (h = Math.min(h, t[d].x), l.push(t[d])) : (c = Math.max(c, t[d].x), u.push(t[d])));
				...
				return OS(e.seriesModels,
					function (e) {
						...
						if (null != l && isFinite(l)) {
							var d = t - l,
								f = Math.abs(d);
							o >= f && ((o > f || d >= 0 && 0 > s) && (o = f, s = d, r = l, a.length = 0), OS(u,
								function (t) {
									a.push({
			...
			function sf(t, e, n, i) {
				if (cf(e) || !t.list.length) return void i({
					type: "hideTip"
				});
			...
			function lf(t, e, n) {
				...
				OS(t,
					function (t) {
						...
						"show" === e.status && OS(e.seriesDataIndices,
							function (t) {
			...
			function df(t, e, n) {
				if (!Kf.node) {
					var i = e.getZr();
					RS(i).records || (RS(i).records = {}),
						ff(i, e);
					var r = RS(i).records[t] || (RS(i).records[t] = {});
					r.handler = n
				}
			}
			function ff(t, e) {
				...
				RS(t).initialized || (RS(t).initialized = !0, n("click", _(vf, "click")), n("mousemove", _(vf, "mousemove")), n("globalout", gf))
			}
			function pf(t, e) {
			...
			function yf(t, e) {
				if (!Kf.node) {
					var n = e.getZr(),
						i = (RS(n).records || {})[t];
					i && (RS(n).records[t] = null)
				}
			}
			function _f() { }
			function xf(t, e, n, i) {
				wf(VS(n).lastProp, i) || (VS(n).lastProp = i, e ? Ja(n, i, t) : (n.stopAnimation(), n.attr(i)))
			}
			function wf(t, e) {
				if (S(t) && S(e)) {
					var n = !0;
			...
			function Tf(t, e, n, i, r) {
				var a = n.get("value"),
					o = Df(a, e.axis, e.ecModel, n.get("seriesDataIndices"), {
						precision: n.get("label.precision"),
						formatter: n.get("label.formatter")
					}),
					s = n.getModel("label"),
					l = xy(s.get("padding") || 0),
					u = s.getFont(),
					h = Yn(o, u),
					c = r.position,
					d = h.width + l[1] + l[3],
			...
			function kf(t, e, n, i, r, a) {
				var o = Cb.innerTextLayout(n.rotation, 0, n.labelDirection);
				n.labelMargin = r.get("label.margin"),
					Tf(e, i, r, a, {
						position: Af(i.axis, t, n),
						align: o.textAlign,
			...
			function Rf(t) {
				var e = [],
					...
					a = t.get("padding");
				return n && e.push(Ef(n)),
					i && (Kf.canvasSupported ? e.push("background-Color:" + i) : (e.push("background-Color:#" + rn(i)), e.push("filter:alpha(opacity=70)"))),
					YS(["width", "color", "radius"],
						function (n) {
							var i = "border-" + n,
								r = US(i),
								a = t.get(r);
					...
					e.push(zf(r)),
					null != a && e.push("padding:" + xy(a).join("px ") + "px"),
					e.join(";") + ";"
			}
			...
			function Ff(t, e, n) {
				...
				this._styleCoord = [0, 0],
					Nf(this._styleCoord, r, a, e.getWidth() / 2, e.getHeight() / 2),
			...
			var qf = 2311,
				...
				Zf = {};
			Zf = "object" == typeof wx && "function" == typeof wx.getSystemInfoSync ? {
				browser: {},
				os: {},
				node: !1,
				wxa: !0,
			...
			var Kf = Zf,
				...
				op = {},
				sp = function () {
					return op.createCanvas()
				};
			op.createCanvas = function () {
				return document.createElement("canvas")
			};
			var lp, up = "__ec_primitive__";
			R.prototype = {
				constructor: R,
				get: function (t) {
			...
			var hp = (Object.freeze || Object)({
				...
				cp = "undefined" == typeof Float32Array ? Array : Float32Array,
				dp = j,
				fp = Z,
				pp = ee,
				gp = ne,
			...
			var _p = Math.log(2),
				xp = "___zrEVENTSAVED",
				wp = [],
				bp = "undefined" != typeof window && !!window.addEventListener,
				Sp = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
				Mp = [],
				Ip = bp ?
					function (t) {
						t.preventDefault(),
			...
			Tp.prototype = {
				...
				_recognize: function (t) {
					for (var e in Cp) if (Cp.hasOwnProperty(e)) {
						var n = Cp[e](this._track, t);
						if (n) return n
					}
				}
			};
			...
			var Ap = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
				kp = function (t, e, n, i) {
					yp.call(this),
						this.storage = t,
						this.painter = e,
			...
			kp.prototype = {
				...
				findHover: function (t, e, n) {
					for (var i = this.storage.getDisplayList(), r = {
						...
						a = i.length - 1; a >= 0; a--) {
						var o;
						if (i[a] !== n && !i[a].ignore && (o = ke(i[a], t, e)) && (!r.topTarget && (r.topTarget = i[a]), o !== Dp)) {
							r.target = i[a];
							break
						}
					}
				...
				processGesture: function (t, e) {
					this._gestureMgr || (this._gestureMgr = new Tp);
					...
					function (t) {
						kp.prototype[t] = function (e) {
							...
							if ("mouseup" === t && o || (n = this.findHover(r, a), i = n.target), "mousedown" === t) this._downEl = i,
								...
								if (this._downEl !== this._upEl || !this._downPoint || pp(this._downPoint, [e.zrX, e.zrY]) > 4) return;
				...
				c(kp, yp),
				c(kp, le);
			var Pp = "undefined" == typeof Float32Array ? Array : Float32Array,
			...
			zp.updateTransform = function () {
				...
				zp.getLocalTransform = function (t) {
					return Ep.getLocalTransform(this, t)
				},
				zp.setTransform = function (t) {
					var e = this.transform,
						n = t.dpr || 1;
					e ? t.setTransform(n * e[0], n * e[1], n * e[2], n * e[3], n * e[4], n * e[5]) : t.setTransform(n, 0, 0, n, 0, 0)
				},
				zp.restoreTransform = function (t) {
					var e = t.dpr || 1;
					t.setTransform(e, 0, 0, e, 0, 0)
				};
			var Np = [],
				Fp = Le();
			zp.setLocalTransform = function (t) {
				if (t) {
				...
				zp.decomposeTransform = function () {
					if (this.transform) {
						var t = this.parent,
							e = this.transform;
						t && t.transform && (Ee(Np, t.invTransform, e), e = Np);
						var n = this.origin;
						n && (n[0] || n[1]) && (Fp[4] = n[0], Fp[5] = n[1], Ee(Np, e, Fp), Np[4] -= n[0], Np[5] -= n[1], e = Np),
							this.setLocalTransform(e)
					}
				},
				zp.getGlobalScale = function (t) {
					var e = this.transform;
					return t = t || [],
						e ? (t[0] = Math.sqrt(e[0] * e[0] + e[1] * e[1]), t[1] = Math.sqrt(e[2] * e[2] + e[3] * e[3]), e[0] < 0 && (t[0] = -t[0]), e[3] < 0 && (t[1] = -t[1]), t) : (t[0] = 1, t[1] = 1, t)
				},
				zp.transformCoordToLocal = function (t, e) {
					var n = [t, e],
						i = this.invTransform;
					return i && ae(n, n, i),
						n
				},
				zp.transformCoordToGlobal = function (t, e) {
					var n = [t, e],
						i = this.transform;
					return i && ae(n, n, i),
						n
				},
				Ep.getLocalTransform = function (t, e) {
					e = e || [],
						Op(e);
					var n = t.origin,
						i = t.scale || [1, 1],
			...
			var Vp = {
				...
				bounceIn: function (t) {
					return 1 - Vp.bounceOut(1 - t)
				},
				bounceOut: function (t) {
					return 1 / 2.75 > t ? 7.5625 * t * t : 2 / 2.75 > t ? 7.5625 * (t -= 1.5 / 2.75) * t + .75 : 2.5 / 2.75 > t ? 7.5625 * (t -= 2.25 / 2.75) * t + .9375 : 7.5625 * (t -= 2.625 / 2.75) * t + .984375
				},
				bounceInOut: function (t) {
					return .5 > t ? .5 * Vp.bounceIn(2 * t) : .5 * Vp.bounceOut(2 * t - 1) + .5
				}
			};
			Ge.prototype = {
				constructor: Ge,
			...
			var tg = 1;
			"undefined" != typeof window && (tg = Math.max(window.devicePixelRatio || 1, 1));
			var eg = 0,
				ng = tg,
				ig = function () { };
			1 === eg && (ig = console.error);
			var rg = ig,
				ag = function () {
					this.animators = []
				};
			ag.prototype = {
				...
				animate: function (t, e) {
					...
					if (!n) return void rg('Property "' + t + '" is not existed in element ' + r.id);
					var c = r.animators,
						d = new Jp(n, e);
			...
			Tn.prototype = {
				...
				union: function (t) {
					var e = lg(t.x, this.x),
						n = lg(t.y, this.y);
					this.width = ug(t.x + t.width, this.x + this.width) - e,
						this.height = ug(t.y + t.height, this.y + this.height) - n,
						this.x = e,
						this.y = n
				},
					...
					return function (r) {
						if (r) {
							t[0] = n[0] = this.x,
								...
								sg(n, n, r),
								sg(i, i, r),
								this.x = lg(t[0], e[0], n[0], i[0]),
								this.y = lg(t[1], e[1], n[1], i[1]);
							var a = ug(t[0], e[0], n[0], i[0]),
								o = ug(t[1], e[1], n[1], i[1]);
							this.width = a - this.x,
			...
			hg.prototype = {
				...
				_doAdd: function (t) {
					...
					var e = this.__storage,
						n = this.__zr;
					e && e !== t.__storage && (e.addToStorage(t), t instanceof hg && t.addChildrenToStorage(e)),
						n && n.refresh()
				},
				remove: function (t) {
					var e = this.__zr,
						...
						i = this._children,
						r = u(i, t);
					return 0 > r ? this : (i.splice(r, 1), t.parent = null, n && (n.delFromStorage(t), t instanceof hg && t.delChildrenFromStorage(n)), e && e.refresh(), this)
				},
				removeAll: function () {
					var t, e, n = this._children,
						i = this.__storage;
					for (e = 0; e < n.length; e++) t = n[e],
						i && (i.delFromStorage(t), t instanceof hg && t.delChildrenFromStorage(i)),
						t.parent = null;
					return n.length = 0,
						this
				},
				...
				addChildrenToStorage: function (t) {
					for (var e = 0; e < this._children.length; e++) {
						...
						t.addToStorage(n),
							n instanceof hg && n.addChildrenToStorage(t)
					}
				},
				delChildrenFromStorage: function (t) {
					for (var e = 0; e < this._children.length; e++) {
						var n = this._children[e];
						t.delFromStorage(n),
							n instanceof hg && n.delChildrenFromStorage(t)
					}
				},
				dirty: function () {
			...
			fg.prototype = {
				...
				addRoot: function (t) {
					t.__storage !== this && (t instanceof hg && t.addChildrenToStorage(this), this.addToStorage(t), this._roots.push(t))
				},
				delRoot: function (t) {
					if (null == t) {
						for (var e = 0; e < this._roots.length; e++) {
							var n = this._roots[e];
							n instanceof hg && n.delChildrenFromStorage(this)
						}
						return this._roots = [],
							this._displayList = [],
					...
					if (t instanceof Array) for (var e = 0,
						...
						r >= 0 && (this.delFromStorage(t), this._roots.splice(r, 1), t instanceof hg && t.delChildrenFromStorage(this))
					}
				},
			...
			var pg = {
				...
				gg = function (t, e, n) {
					return pg.hasOwnProperty(e) ? n *= t.dpr : n
				},
				vg = {
					NONE: 0,
					STYLE_BIND: 1,
				...
				mg = 9,
				yg = [["shadowBlur", 0], ["shadowOffsetX", 0], ["shadowOffsetY", 0], ["shadowColor", "#000"], ["lineCap", "butt"], ["lineJoin", "miter"], ["miterLimit", 10]],
				_g = function (t) {
					this.extendFrom(t, !1)
				};
			_g.prototype = {
				...
				bind: function (t, e, n) {
					var i = this,
						r = n && n.style,
						a = !r || t.__attrCachedBy !== vg.STYLE_BIND;
					t.__attrCachedBy = vg.STYLE_BIND;
					for (var o = 0; o < yg.length; o++) {
						var s = yg[o],
							l = s[0]; (a || i[l] !== r[l]) && (t[l] = gg(t, l, i[l] || s[1]))
					}
			...
			for (var xg = _g.prototype,
				wg = 0; wg < yg.length; wg++) {
				var bg = yg[wg];
				bg[0] in xg || (xg[bg[0]] = bg[1])
			}
			_g.getGradient = xg.getGradient;
			var Sg = function (t, e) {
				this.image = t,
					this.repeat = e,
					this.type = "pattern"
			};
			Sg.prototype.getCanvasPattern = function (t) {
			...
			Mg.prototype = {
				...
				clear: function (t, e) {
					...
					if (o && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(n, 0, 0, r / l, a / l)), i.clearRect(0, 0, r, a), e && "transparent" !== e) {
						var u;
						e.colorStops ? (u = e.__canvasGradient || _g.getGradient(i, e, {
							x: 0,
							y: 0,
							width: r,
							height: a
						}), e.__canvasGradient = u) : e.image && (u = Sg.prototype.getCanvasPattern.call(e, i)),
							i.save(),
							i.fillStyle = u || e,
							i.fillRect(0, 0, r, a),
							i.restore()
			...
			var Ig = "undefined" != typeof window && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.msRequestAnimationFrame && window.msRequestAnimationFrame.bind(window) || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) ||
				function (t) {
					setTimeout(t, 16)
				},
				Tg = new Xp(50),
			...
			var Og = Pg,
				...
				zg = [["textShadowBlur", "shadowBlur", 0], ["textShadowOffsetX", "shadowOffsetX", 0], ["textShadowOffsetY", "shadowOffsetY", 0], ["textShadowColor", "shadowColor", "transparent"]],
				Rg = {},
				Ng = {},
				Fg = new Tn,
				Vg = function () { };
			Vg.prototype = {
				...
				drawRectText: function (t, e) {
					...
					if (null != i && (i += ""), Ii(i, n)) {
						...
						n.transformText ? this.setTransform(t) : r && (Fg.copy(e), Fg.applyTransform(r), e = Fg),
							hi(this, t, i, n, e, mg),
							t.restore()
					}
				}
				...
				Ti.prototype = {
					...
					attrKV: function (t, e) {
						"style" !== t ? og.prototype.attrKV.call(this, t, e) : this.style.set(e)
					},
					...
					useStyle: function (t) {
						return this.style = new _g(t, this),
							this.dirty(!1),
							this
					},
			...
			var Hg = 1e5,
				...
				qg = function (t, e, n) {
					...
					this._opts = n = o({},
						n || {}),
						this.dpr = n.devicePixelRatio || ng,
			...
			qg.prototype = {
				...
				refreshHover: function () {
					...
					if (n && n.clear(), e) {
						Bn(t, this.storage.displayableSortFunc),
							n || (n = this._hoverlayer = this.getLayer(Hg));
						var i = {};
						n.ctx.save();
						for (var r = 0; e > r;) {
							var a = t[r],
				...
				getLayer: function (t, e) {
					this._singleCanvas && !this._needsManuallyCompositing && (t = Gg);
					var n = this._layers[t];
					return n || (n = new Mg("zr_" + t, this, this.dpr), n.zlevel = t, n.__builtin__ = !0, this._layerConfig[t] && r(n, this._layerConfig[t], !0), e && (n.virtual = e), this.insertLayer(t, n), n.initContext()),
						n
				},
				insertLayer: function (t, e) {
					var n = this._layers,
						...
						o = -1,
						s = this._domRoot;
					if (n[t]) return void rg("ZLevel " + t + " has been used already");
					if (!Ai(e)) return void rg("Layer of zlevel " + t + " is not valid");
					if (r > 0 && t > i[0]) {
				...
				_updateLayerStatus: function (t) {
					...
					for (var r = null,
						...
						var o, i = t[n],
							s = i.zlevel;
						i.incremental ? (o = this.getLayer(s + Xg, this._needsManuallyCompositing), o.incremental = !0, a = 1) : o = this.getLayer(s + (a > 0 ? Wg : 0), this._needsManuallyCompositing),
							o.__builtin__ || rg("ZLevel " + s + " has been used by unkown layer " + o.id),
				...
				getRenderedCanvas: function (t) {
					if (t = t || {},
						this._singleCanvas && !this._compositeManually) return this._layers[Gg].dom;
					var e = new Mg("image", this, t.pixelRatio || this.dpr);
			...
			jg.prototype = {
				...
				_startLoop: function () {
					function t() {
						e._running && (Ig(t), !e._paused && e._update())
					}
					var e = this;
					this._running = !0,
						Ig(t)
				...
				animate: function (t, e) {
					e = e || {};
					var n = new Jp(t, e.loop, e.getter, e.setter);
			...
			var Zg = 300,
				...
				Jg = Vi.prototype;
			Jg.stopPropagation = Jg.stopImmediatePropagation = Jg.preventDefault = V;
			var tv = {
				...
				mousemove: function (t) {
					t = be(this.dom, t);
					var e = this._mayPointerCapture; !e || t.zrX === e[0] && t.zrY === e[1] || Yi(this, !0),
				...
				touchstart: function (t) {
					t = be(this.dom, t),
						...
						tv.mousemove.call(this, t),
						tv.mousedown.call(this, t)
				},
				...
				touchend: function (t) {
					t = be(this.dom, t),
						...
						tv.mouseup.call(this, t),
						+new Date - this._lastTouchMoment < Zg && tv.click.call(this, t)
				},
				pointerdown: function (t) {
					tv.mousedown.call(this, t)
				},
				pointermove: function (t) {
					Ei(t) || tv.mousemove.call(this, t)
				},
				pointerup: function (t) {
					tv.mouseup.call(this, t)
				},
				pointerout: function (t) {
					Ei(t) || tv.mouseout.call(this, t)
				}
			};
			...
			var ev = {
				pointermove: function (t) {
					Ei(t) || ev.mousemove.call(this, t)
				},
				pointerup: function (t) {
					ev.mouseup.call(this, t)
				},
				mousemove: function (t) {
					this.trigger("mousemove", t)
				},
			...
			nv.dispose = function () {
				Xi(this._localHandlerScope),
					Kg && Xi(this._globalHandlerScope)
			},
				nv.setCursor = function (t) {
					this.dom.style && (this.dom.style.cursor = t || "default")
				},
				c(qi, yp);
			var iv = !Kf.canvasSupported,
				rv = {
					canvas: qg
				},
				av = {},
				...
				sv = function (t, e, n) {
					...
					var o = new rv[a](e, r, n, t);
					this.storage = r,
						this.painter = o;
					var s = Kf.node || Kf.worker ? null : new qi(o.getViewportRoot(), o.root);
					this.handler = new kp(r, o, s, o.root),
			...
			var lv = (Object.freeze || Object)({
				...
				pv = 0,
				gv = ".",
				vv = "___EC__COMPONENT__CONTAINER___",
				mv = 0,
				yv = function (t) {
				...
				_v = yv([["lineWidth", "width"], ["stroke", "color"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"]]),
				xv = {
				...
				wv = yv([["fill", "color"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["opacity"], ["shadowColor"]]),
				bv = {
			...
			tm.prototype = {
				...
				setScale: function (t, e, n) {
					n = n || 0,
						this._ux = Qv(n / ng / t) || 0,
						this._uy = Qv(n / ng / e) || 0
				},
				getContext: function () {
					return this._ctx
				},
				...
				lineTo: function (t, e) {
					var n = Qv(t - this._xi) > this._ux || Qv(e - this._yi) > this._uy || this._len < 5;
					return this.addData(Gv.L, t, e),
						this._ctx && n && (this._needsDash() ? this._dashedLineTo(t, e) : this._ctx.lineTo(t, e)),
						n && (this._xi = t, this._yi = e),
						this
				},
				bezierCurveTo: function (t, e, n, i, r, a) {
					return this.addData(Gv.C, t, e, n, i, r, a),
				...
				quadraticCurveTo: function (t, e, n, i) {
					return this.addData(Gv.Q, t, e, n, i),
				...
				arc: function (t, e, n, i, r, a) {
					return this.addData(Gv.A, t, e, n, n, i, r - i, 0, a ? 0 : 1),
				...
				appendPath: function (t) {
					...
					for (var e = t.length,
						...
						i = this._len,
						r = 0; e > r; r++) n += t[r].len();
					Jv && this.data instanceof Float32Array && (this.data = new Float32Array(i + n));
				...
				_dashedLineTo: function (t, e) {
					...
					for (h /= d, c /= d, 0 > a && (a = r + a), a %= r, f -= a * h, p -= a * c; h > 0 && t >= f || 0 > h && f >= t || 0 === h && (c > 0 && e >= p || 0 > c && p >= e);) i = this._dashIdx,
						...
						p += c * n,
						this._dashIdx = (i + 1) % g,
						h > 0 && l > f || 0 > h && f > l || c > 0 && u > p || 0 > c && p > u || s[i % 2 ? "moveTo" : "lineTo"](h >= 0 ? qv(f, t) : jv(f, t), c >= 0 ? qv(p, e) : jv(p, e));
					h = f - t,
						c = p - e,
						this._dashOffset = -$v(h * h + c * c)
				},
				...
				getBoundingRect: function () {
					Wv[0] = Wv[1] = Yv[0] = Yv[1] = Number.MAX_VALUE,
						Xv[0] = Xv[1] = Uv[0] = Uv[1] = -Number.MAX_VALUE;
					for (var t = this.data,
						e = 0,
						n = 0,
						i = 0,
						...
						switch (1 === a && (e = t[a], n = t[a + 1], i = e, r = n), o) {
							case Gv.M:
								...
								break;
							case Gv.L:
								zr(e, n, t[a], t[a + 1], Yv, Uv),
									e = t[a++],
									n = t[a++];
								break;
							case Gv.C:
								Rr(e, n, t[a++], t[a++], t[a++], t[a++], t[a], t[a + 1], Yv, Uv),
									e = t[a++],
									n = t[a++];
								break;
							case Gv.Q:
								Nr(e, n, t[a++], t[a++], t[a], t[a + 1], Yv, Uv),
									e = t[a++],
									n = t[a++];
								break;
							case Gv.A:
								...
								a += 1;
								var f = 1 - t[a++];
								1 === a && (i = Zv(c) * u + s, r = Kv(c) * h + l),
									Fr(s, l, u, h, c, d, f, Yv, Uv),
									e = Zv(d) * u + s,
									n = Kv(d) * h + l;
								break;
							case Gv.R:
					...
					return 0 === a && (Wv[0] = Wv[1] = Xv[0] = Xv[1] = 0),
						new Tn(Wv[0], Wv[1], Xv[0] - Wv[0], Xv[1] - Wv[1])
				},
					...
					for (var e, n, i, r, a, o, s = this.data,
						...
						switch (1 === c && (i = s[c], r = s[c + 1], e = i, n = r), d) {
							...
							case Gv.L:
								a = s[c++],
									o = s[c++],
									(Qv(a - i) > l || Qv(o - r) > u || c === h - 1) && (t.lineTo(a, o), i = a, r = o);
								break;
							case Gv.C:
			...
			var em = 2 * Math.PI,
				...
				om = [- 1, -1, -1],
				sm = [- 1, -1],
				lm = Sg.prototype.getCanvasPattern,
				um = Math.abs,
				hm = new tm(!0);
			ta.prototype = {
				constructor: ta,
				...
				brush: function (t, e) {
					...
					l ? t.fillStyle = this._fillGradient : h && (t.fillStyle = lm.call(o, t)),
						u ? t.strokeStyle = this._strokeGradient : c && (t.strokeStyle = lm.call(s, t));
					var f = n.lineDash,
						p = n.lineDashOffset,
						g = !!t.setLineDash,
				...
				getLineScale: function () {
					...
					return t && um(t[0] - 1) > 1e-10 && um(t[3] - 1) > 1e-10 ? Math.sqrt(um(t[0] * t[3] - t[2] * t[1])) : 1
				}
			},
			...
			var cm = tm.CMD,
					...
					for (r = 0, a = 0; r < l.length;) {
						switch (n = l[r++], a = r, i = 0, n) {
							...
							case f:
								var g = e[4],
									v = e[5],
									m = fm(e[0] * e[0] + e[1] * e[1]),
									y = fm(e[2] * e[2] + e[3] * e[3]),
									_ = pm(- e[1] / y, e[0] / m);
								l[r] *= m,
									l[r++] += g,
									l[r] *= y,
				...
				wm = function (t, e) {
					return (t[0] * e[0] + t[1] * e[1]) / (xm(t) * xm(e))
				},
				bm = function (t, e) {
					return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(wm(t, e))
				},
				Sm = /([mlvhzcqtsa])([^mlvhzcqtsa]*)/gi,
				Mm = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g,
				Im = function (t) {
					Ti.call(this, t)
				};
			Im.prototype = {
				...
				brush: function (t, e) {
					...
					var i = n.text;
					return null != i && (i += ""),
						Ii(i, n) ? (this.setTransform(t), hi(this, t, i, n, null, e), void this.restoreTransform(t)) : void (t.__attrCachedBy = vg.NONE)
				},
				getBoundingRect: function () {
					var t = this.style;
			...
			var Tm = ta.extend({
				...
				Cm = [["shadowBlur", 0], ["shadowColor", "#000"], ["shadowOffsetX", 0], ["shadowOffsetY", 0]],
				Dm = function (t) {
						...
						function () {
							...
							if (n) for (var r = 0; r < n.length; r++) {
								...
								if (o && ("sector" === s && o.startAngle === o.endAngle || "rect" === s && (!o.width || !o.height))) {
									for (var l = 0; l < Cm.length; l++) Cm[l][2] = i[Cm[l][0]],
										i[Cm[l][0]] = Cm[l][1];
									e = !0;
									break
								}
							}
							if (t.apply(this, arguments), e) for (var l = 0; l < Cm.length; l++) i[Cm[l][0]] = Cm[l][2]
						} : t
				},
				Am = ta.extend({
					type: "sector",
				...
				Rm = ta.extend({
					...
					buildPath: function (t, e) {
						var n, i, r, a;
						this.subPixelOptimize ? (ha(zm, e, this.style), n = zm.x, i = zm.y, r = zm.width, a = zm.height, zm.r = e.r, e = zm) : (n = e.x, i = e.y, r = e.width, a = e.height),
				...
				Fm = ta.extend({
					...
					buildPath: function (t, e) {
						var n, i, r, a;
						this.subPixelOptimize ? (ua(Nm, e, this.style), n = Nm.x1, i = Nm.y1, r = Nm.x2, a = Nm.y2) : (n = e.x1, i = e.y1, r = e.x2, a = e.y2);
						var o = e.percent;
				...
				Hm = ta.extend({
					...
					buildPath: function (t, e) {
						var n = e.x1,
							...
							u = e.cpy2,
							h = e.percent;
						0 !== h && (t.moveTo(n, i), null == l || null == u ? (1 > h && (Or(n, o, r, h, Vm), o = Vm[1], r = Vm[2], Or(i, s, a, h, Vm), s = Vm[1], a = Vm[2]), t.quadraticCurveTo(o, s, r, a)) : (1 > h && (Cr(n, o, l, r, h, Vm), o = Vm[1], l = Vm[2], r = Vm[3], Cr(i, s, u, a, h, Vm), s = Vm[1], u = Vm[2], a = Vm[3]), t.bezierCurveTo(o, s, l, u, r, a)))
					},
					pointAt: function (t) {
			...
			fa.prototype.getBoundingRect = function () {
				if (!this._rect) {
					for (var t = new Tn(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0; e < this._displayables.length; e++) {
						...
						n.needLocalTransform() && i.applyTransform(n.getLocalTransform(qm)),
							t.union(i)
					}
					this._rect = t
				}
			...
			var ly = (Object.freeze || Object)({
				Z2_EMPHASIS_LIFT: $m,
				CACHED_LABEL_STYLE_PROPERTIES: Qm,
				extendShape: pa,
				extendPath: ga,
				registerShape: va,
				getShapeClass: ma,
				...
				hy = {
					getTextColor: function (t) {
						var e = this.ecModel;
						return this.getShallow("color") || (!t && e ? e.get(uy) : null)
					},
					getFont: function () {
						return $a({
				...
				cy = yv([["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"], ["textPosition"], ["textAlign"]]),
				dy = {
			...
			var gy = 0,
				vy = 1e-4,
				my = 9007199254740991,
				yy = /^(?:(\d{4})(?:[-\/](\d{1,2})(?:[-\/](\d{1,2})(?:[T ](\d{1,2})(?::(\d\d)(?::(\d\d)(?:[.,](\d+))?)?)?(Z|[\+\-]\d\d:?\d\d)?)?)?)?)?$/,
				...
				Cy = f,
				Dy = ["left", "right", "top", "bottom", "width", "height"],
				Ay = [["width", "left", "right"], ["height", "top", "bottom"]],
				ky = jo,
				Py = (_(jo, "vertical"), _(jo, "horizontal"), {
			...
			xr(Oy, {
				...
				c(Oy, Py);
			var By = "";
			"undefined" != typeof navigator && (By = navigator.platform || "");
			var Ey = {
				color: ["#c23531", "#2f4554", "#61a0a8", "#d48265", "#91c7ae", "#749f83", "#ca8622", "#bda29a", "#6e7074", "#546570", "#c4ccd3"],
				gradientColor: ["#f6efa6", "#d88273", "#bf444c"],
				textStyle: {
					fontFamily: By.match(/^Win/) ? "Microsoft YaHei" : "sans-serif",
					fontSize: 12,
					fontStyle: "normal",
					fontWeight: "normal"
				},
			...
			var Uy = {
				...
				Zy = fo.extend({
					...
					setOption: function (t, e) {
						O(!(jy in t), "please use chart.getOption()"),
					...
					mergeOption: function (t) {
								...
								f(s,
									function (t, i) {
										...
										if (O(S(s) || r, "Empty component definition"), s) {
											var u = Oy.getClass(e, t.keyInfo.subType, !0);
						...
						rs(this),
							f(t,
								function (t, e) {
									null != t && (Oy.hasClass(e) ? e && s.push(e) : n[e] = null == n[e] ? i(t) : r(n[e], t, !0))
								}),
							Oy.topologicalTravel(s, Oy.getAllClassMainTypes(), e, this),
					...
					restoreData: function (t) {
						...
						e.each(function (t, e) {
							...
							Oy.topologicalTravel(n, Oy.getAllClassMainTypes(),
								function (n) {
									f(e.get(n),
										function (e) {
			...
			c(Zy, Ry);
			var Ky = ["getDom", "getZr", "getWidth", "getHeight", "getDevicePixelRatio", "dispatchAction", "isDisposed", "on", "off", "getDataURL", "getConnectedDataURL", "getModel", "getOption", "getViewOfComponentModel", "getViewOfSeriesModel"],
				$y = {};
			Ss.prototype = {
				constructor: Ss,
				create: function (t, e) {
			...
			Ms.prototype = {
				...
				mountOption: function (t) {
					...
					return this._timelineOptions = t_(e.timelineOptions, Jy),
						this._mediaList = t_(e.mediaList, Jy),
						this._mediaDefault = Jy(e.mediaDefault),
						this._currentMediaIndices = [],
						Jy(t ? e.baseOption : this._newBaseOption)
				},
				getTimelineOption: function (t) {
					var e, n = this._timelineOptions;
					if (n.length) {
						var i = t.getComponent("timeline");
						i && (e = Jy(n[i.getCurrentIndex()], !0))
					}
					return e
				},
				getMediaOption: function () {
					...
					for (var o = 0,
						s = n.length; s > o; o++) Ts(n[o].query, t, e) && r.push(o);
					return !r.length && i && (r = [- 1]),
						r.length && !Ds(r, this._currentMediaIndices) && (a = t_(r,
							function (t) {
								return Jy(- 1 === t ? i.option : n[t].option)
							})),
			...
			var i_ = f,
				r_ = S,
				a_ = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"],
				o_ = function (t, e) {
					i_(zs(t.series),
						function (t) {
							r_(t) && Es(t)
				...
				s_ = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]],
				l_ = ["grid", "geo", "parallel", "legend", "toolbox", "title", "visualMap", "dataZoom", "timeline"],
				u_ = function (t, e) {
					o_(t, e),
			...
			m_.perform = function (t) {
				...
				if (this._dueEnd = n ? n._outputDueEnd : this._count ? this._count(this.context) : 1 / 0, this._progress) {
					...
					if (!i && (h || f > d)) {
						...
						if (x(p)) for (var g = 0; g < p.length; g++) Js(this, p[g], d, f, l, u);
			...
			m_.dirty = function () {
				...
				m_.getUpstream = function () {
					return this._upstream
				},
				m_.getDownstream = function () {
					return this._downstream
				},
				m_.setOutputEnd = function (t) {
			...
			var __ = lr(),
				x_ = Oy.extend({
					...
					getRawData: function () {
						return __(this).dataBeforeProcessed
					},
					...
					getColorFromPalette: function (t, e, n) {
						var i = this.ecModel,
							r = Ry.getColorFromPalette.call(this, t, e, n);
			...
			var b_ = w_.prototype;
			b_.updateView = b_.updateLayout = b_.updateVisual = function () { },
				vr(w_),
				xr(w_, {
					registerWhenExtend: !0
				});
			...
			var T_ = ul.prototype;
			T_.updateView = T_.updateLayout = T_.updateVisual = function (t, e, n, i) {
				this.render(t, e, n, i)
			},
				vr(ul, ["dispose"]),
				xr(ul, {
			...
			var C_ = {
				...
				D_ = "\x00__throttleOriginMethod",
				A_ = "\x00__throttleRate",
				k_ = "\x00__throttleType",
				P_ = {
					createOnAllSeries: !0,
					performRawSeries: !0,
					reset: function (t, e) {
						var n = t.getData(),
							...
							r = t.get(i),
							a = !w(r) || r instanceof Xm ? null : r; (!r || a) && (r = t.getColorFromPalette(t.name, null, e.getSeriesCount())),
								n.setVisual("color", r);
				...
				O_ = function (t, e) {
					...
					function i(t) {
						var e = o.get(t);
						if (null == e) {
							for (var n = t.split("."), i = L_.aria, r = 0; r < n.length; ++r) i = i[n[r]];
							return i
						}
						return e
					}
					...
					function a(t) {
						return L_.series.typeNames[t] || "自定义图"
					}
			...
			z_.restoreData = function (t, e) {
				...
				z_.getPerformArgs = function (t, e) {
					if (t.__pipeline) {
				...
				z_.getPipeline = function (t) {
					return this._pipelineMap.get(t)
				},
				z_.updateStreamModes = function (t, e) {
				...
				z_.restorePipelines = function (t) {
					var e = this,
						n = e._pipelineMap = N();
					t.eachSeries(function (t) {
					...
					f(this._allHandlers,
						function (i) {
							...
							i.reset && yl(this, i, r, e, n),
								i.overallReset && _l(this, i, r, e, n)
						},
						this)
				},
				z_.prepareView = function (t, e, n, i) {
					var r = t.renderTask,
						a = r.context;
					a.model = e,
						a.ecModel = n,
				...
				z_.performDataProcessorTasks = function (t, e) {
					ml(this, this._dataProcessorHandlers, t, e, {
						block: !0
					})
				},
				z_.performVisualTasks = function (t, e, n) {
					ml(this, this._visualHandlers, t, e, n)
				},
				z_.performSeriesTasks = function (t) {
					var e;
					t.eachSeries(function (t) {
			...
			var R_ = z_.updatePayload = function (t, e) {
			...
			kl(V_, Zy),
				kl(H_, bs),
				V_.eachSeriesByType = V_.eachRawSeriesByType = function (t) {
					F_ = t
				},
				V_.eachComponent = function (t) {
					"series" === t.mainType && t.subType && (F_ = t.subType)
				};
			var G_ = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"],
				...
				U_ = ["#dd6b66", "#759aa0", "#e69d87", "#8dc1a9", "#ea7e53", "#eedd78", "#73a373", "#73b9bc", "#7289ab", "#91ca8c", "#f49f42"],
				q_ = {
					color: U_,
					backgroundColor: "#333",
					tooltip: {
			...
			q_.categoryAxis.splitLine.show = !1,
				Oy.extend({
					type: "dataset",
					defaultOption: {
						seriesLayoutBy: Xy,
			...
			Ll.prototype.parse = function (t, e) {
				...
				return e.ignoreRootClip || null == a || null == o || i.setClipPath(new Rm({
					shape: {
						x: 0,
						y: 0,
						width: a,
			...
			var K_ = {
				...
				J_ = /url\(\s*#(.*?)\)/,
				tx = /(translate|scale|rotate|skewX|skewY|matrix)\(([\-\s0-9\.e,]*)\)/g,
				ex = /([^\s:;]+)\s*:\s*([^:;]+)/g,
				nx = N(),
				ix = {
				...
				Ix = {
					...
					VISUAL: {
						LAYOUT: mx,
						PROGRESSIVE_LAYOUT: yx,
						GLOBAL: _x,
						CHART: xx,
						POST_CHART_LAYOUT: bx,
						COMPONENT: Sx,
						BRUSH: Mx
					}
				},
				...
				Cx = "__optionUpdated",
				Dx = /^[a-zA-Z0-9_]+$/;
			Gl.prototype.on = Hl("on", !0),
				Gl.prototype.off = Hl("off", !0),
				Gl.prototype.one = Hl("one", !0),
				c(Gl, yp);
			var Ax = Wl.prototype;
			Ax._onframe = function () {
				if (!this._disposed) {
					...
					if (this[Cx]) {
						...
						do {
							var a = +new Date;
							t.performSeriesTasks(i), t.performDataProcessorTasks(i), ql(this, i), t.performVisualTasks(i), nu(this, this._model, r, "remain"), n -= +new Date - a
				...
				Ax.setOption = function (t, e, n) {
					if (!this._disposed) {
						var i;
						if (lx(e) && (n = e.lazyUpdate, i = e.silent, e = e.notMerge), this[Tx] = !0, !this._model || e) {
							var r = new Ms(this._api),
								a = this._theme,
								o = this._model = new Zy;
							o.scheduler = this._scheduler,
								o.init(null, null, a, r)
						}
						this._model.setOption(t, Ex),
							n ? (this[Cx] = {
								silent: i
							},
								this[Tx] = !1) : (Yl(this), kx.update.call(this), this._zr.flush(), this[Cx] = !1, this[Tx] = !1, Zl.call(this, i), Kl.call(this, i))
					}
				},
				Ax.setTheme = function () {
					console.error("ECharts#setTheme() is DEPRECATED in ECharts 3.0")
				},
				Ax.getModel = function () {
					return this._model
				},
				Ax.getOption = function () {
					return this._model && this._model.getOption()
				},
				Ax.getWidth = function () {
					return this._zr.getWidth()
				},
				Ax.getHeight = function () {
					return this._zr.getHeight()
				},
				Ax.getDevicePixelRatio = function () {
					return this._zr.painter.dpr || window.devicePixelRatio || 1
				},
				Ax.getRenderedCanvas = function (t) {
				...
				Ax.getConnectedDataURL = function (t) {
					if (!this._disposed && Kf.canvasSupported) {
						var e = this.group,
							n = Math.min,
							r = Math.max,
							a = 1 / 0;
						if (Hx[e]) {
							...
							g.width = d,
								g.height = p;
							var v = ji(g);
							return t.connectedBackgroundColor && v.add(new Rm({
								shape: {
									x: 0,
									y: 0,
									width: d,
				...
				Ax.convertToPixel = _(Xl, "convertToPixel"),
				Ax.convertFromPixel = _(Xl, "convertFromPixel"),
				Ax.containPixel = function (t, e) {
					if (!this._disposed) {
						var n, i = this._model;
						return t = ur(i, t),
							f(t,
				...
				Ax.getViewOfComponentModel = function (t) {
					return this._componentsMap[t.__viewId]
				},
				Ax.getViewOfSeriesModel = function (t) {
			...
			var kx = {
				...
				update: function (t) {
					...
					if (e) {
						...
						if (Kf.canvasSupported) i.setBackgroundColor(o);
						else {
							var s = Je(o);
							o = un(s, "rgb"),
								0 === s[3] && (o = "transparent")
			...
			Ax.resize = function (t) {
				...
				Ax.showLoading = function (t, e) {
					if (!this._disposed && (lx(t) && (e = t, t = ""), t = t || "default", this.hideLoading(), Fx[t])) {
				...
				Ax.hideLoading = function () {
					this._disposed || (this._loadingFX && this._zr.remove(this._loadingFX), this._loadingFX = null)
				},
				Ax.makeActionFromEvent = function (t) {
					var e = o({},
						t);
					return e.type = Ox[t.type],
						e
				},
				Ax.dispatchAction = function (t, e) {
					if (!this._disposed && (lx(e) || (e = {
						silent: !!e
					}), Lx[t.type] && this._model)) {
						if (this[Tx]) return void this._pendingActions.push(t);
						jl.call(this, t, e.silent),
							e.flush ? this._zr.flush(!0) : e.flush !== !1 && Kf.browser.weChat && this._throttledZrFlush(),
				...
				Ax.off = Hl("off", !1),
				Ax.one = Hl("one", !1);
			var Px = ["click", "dblclick", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "globalout", "contextmenu"];
			Ax._initEvents = function () {
				ox(Px,
					function (t) {
						var e = function (e) {
				...
				Ax.dispose = function () {
					if (!this._disposed) {
						...
						var t = this._api,
							e = this._model;
						ox(this._componentsViews,
							function (n) {
								n.dispose(e, t)
							}),
							ox(this._chartsViews,
								function (n) {
									n.dispose(e, t)
								}),
							this._zr.dispose(),
			...
			var qx = N(["tooltip", "label", "itemName", "itemId", "seriesName"]),
				...
				$x = "e\x00\x00",
				Qx = {
					"float": typeof Float64Array === Zx ? Array : Float64Array,
					"int": typeof Int32Array === Zx ? Array : Int32Array,
					ordinal: Array,
					number: Array,
					time: Array
				},
				Jx = typeof Uint32Array === Zx ? Array : Uint32Array,
				tw = typeof Int32Array === Zx ? Array : Int32Array,
				ew = typeof Uint16Array === Zx ? Array : Uint16Array,
				nw = ["hasItemOption", "_nameList", "_idList", "_invertedIndicesMap", "_rawData", "_chunkSize", "_chunkCount", "_dimValueGetter", "_count", "_rawCount", "_nameDimIdx", "_idDimIdx"],
			...
			aw.type = "list",
				...
				aw.initData = function (t, e, n) {
					...
					i && (t = new Gs(t, this.dimensions.length)),
						...
						this.defaultDimValueGetter = p_[this._rawData.getSource().sourceFormat],
						this._dimValueGetter = n = n || this.defaultDimValueGetter,
						this._dimValueGetterArrayRows = p_.arrayRows,
						this._rawExtent = {},
						this._initDataFromProvider(0, t.count()),
						t.pure && (this.hasItemOption = !1)
				},
				aw.getProvider = function () {
					return this._rawData
				},
				aw.appendData = function (t) {
					var e = this._rawData,
						n = this.count();
					e.appendData(t);
					var i = e.count();
				...
				aw._initDataFromProvider = function (t, e) {
					if (!(t >= e)) {
				...
				aw._getFast = function (t, e) {
					var n = Math.floor(e / this._chunkSize),
						i = e % this._chunkSize,
						r = this._storage[t][n];
					return r[i]
				},
				aw.getValues = function (t, e) {
					var n = [];
				...
				aw.rawIndexOf = function (t, e) {
					var n = t && this._invertedIndicesMap[t],
						i = n[e];
					return null == i || isNaN(i) ? Kx : i
				},
				aw.indexOfName = function (t) {
					for (var e = 0,
						n = this.count(); n > e; e++) if (this.getName(e) === t) return e;
					return - 1
				},
				aw.indexOfRawIndex = function (t) {
				...
				aw.indicesOfNearest = function (t, e, n) {
					var i = this._storage,
						r = i[t],
						a = [];
					if (!r) return a;
				...
				aw.filterSelf = function (t, e, n, i) {
					if (this._count) {
						"function" == typeof t && (i = n, n = e, e = t, t = []),
							n = n || i || this,
							t = p($u(t), this.getDimension, this);
						...
						return r > u && (this._indices = o),
							this._count = u,
							this._extent = {},
							this.getRawIndex = this._indices ? Zu : ju,
							this
					}
				},
				aw.selectRange = function (t) {
					if (this._count) {
						var e = [];
				...
				aw.map = function (t, e, n, i) {
					n = n || i || this,
						t = p($u(t), this.getDimension, this);
					var r = Qu(this, t);
					r._indices = this._indices,
						r.getRawIndex = r._indices ? Zu : ju;
				...
				aw.downSample = function (t, e, n, i) {
					for (var r = Qu(this, [t]), a = r._storage, o = [], s = Math.floor(1 / e), l = a[t], u = this.count(), h = this._chunkSize, c = r._rawExtent[t], d = new (Gu(this))(u), f = 0, p = 0; u > p; p += s) {
				...
				aw.getVisual = function (t) {
					var e = this._visual;
					return e && e[t]
				},
				aw.setVisual = function (t, e) {
					if (jx(t)) for (var n in t) t.hasOwnProperty(n) && this.setVisual(n, t[n]);
					else this._visual = this._visual || {},
						this._visual[t] = e
				},
				aw.setLayout = function (t, e) {
					if (jx(t)) for (var n in t) t.hasOwnProperty(n) && this.setLayout(n, t[n]);
					else this._layout[t] = e
				},
				aw.getLayout = function (t) {
					return this._layout[t]
				},
				aw.getItemLayout = function (t) {
					return this._itemLayouts[t]
				},
				aw.setItemLayout = function (t, e, n) {
					this._itemLayouts[t] = n ? o(this._itemLayouts[t] || {},
						e) : e
				},
				aw.clearItemLayouts = function () {
					this._itemLayouts.length = 0
				},
				aw.getItemVisual = function (t, e, n) {
					var i = this._itemVisuals[t],
						r = i && i[e];
					return null != r || n ? r : this.getVisual(e)
				},
				aw.setItemVisual = function (t, e, n) {
					var i = this._itemVisuals[t] || {},
						r = this.hasItemVisual;
					if (this._itemVisuals[t] = i, jx(e)) for (var a in e) e.hasOwnProperty(a) && (i[a] = e[a], r[a] = !0);
					else i[e] = n,
						r[e] = !0
				},
				aw.clearAllVisual = function () {
					this._visual = {},
						this._itemVisuals = [],
						this.hasItemVisual = {}
				};
			...
			aw.setItemGraphicEl = function (t, e) {
				var n = this.hostModel;
				e && (e.dataIndex = t, e.dataType = this.dataType, e.seriesIndex = n && n.seriesIndex, "group" === e.type && e.traverse(ow, e)),
					this._graphicEls[t] = e
			},
				aw.getItemGraphicEl = function (t) {
					return this._graphicEls[t]
				},
				aw.eachItemGraphicEl = function (t, e) {
					f(this._graphicEls,
						function (n, i) {
							n && t && t.call(e, n, i)
						})
				},
				aw.cloneShallow = function (t) {
					if (!t) {
						var e = p(this.dimensions, this.getDimensionInfo, this);
						t = new rw(e, this.hostModel)
					}
					if (t._storage = this._storage, Xu(t, this), this._indices) {
						var n = this._indices.constructor;
						t._indices = new n(this._indices)
					} else t._indices = null;
					return t.getRawIndex = t._indices ? Zu : ju,
						t
				},
				aw.wrapMethod = function (t, e) {
					var n = this[t];
				...
				aw.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "map"],
				aw.CHANGABLE_METHODS = ["filterSelf", "selectRange"];
			var sw = function (t, e) {
				return e = e || {},
			...
			var uw = ph.prototype;
			uw.getOrdinal = function (t) {
				return gh(this).get(t)
			},
				uw.parseAndCollect = function (t) {
				...
				cw = fh.extend({
					...
					contain: function (t) {
						return t = this.parse(t),
							hw.contain.call(this, t) && null != this._ordinalMeta.categories[t]
					},
					normalize: function (t) {
						return hw.normalize.call(this, this.parse(t))
					},
					scale: function (t) {
						return Math.round(hw.scale.call(this, t))
					},
					getTicks: function () {
			...
			var dw = bo,
				...
				pw = fh.extend({
					...
					unionExtent: function (t) {
						...
						t[0] < e[0] && (e[0] = t[0]),
							t[1] > e[1] && (e[1] = t[1]),
							pw.prototype.setExtent.call(this, e[0], e[1])
					},
					...
					getTicks: function (t) {
						...
						if (!e) return a;
						var o = 1e4;
						n[0] < i[0] && a.push(t ? fw(i[0] - e, r) : n[0]);
						for (var s = i[0]; s <= i[1] && (a.push(s), s = fw(s + e, r), s !== a[a.length - 1]);) if (a.length > o) return [];
						var l = a.length ? a[a.length - 1] : i[1];
						return n[1] > l && a.push(t ? fw(l + e, r) : n[1]),
							a
					},
					...
					niceExtent: function (t) {
						...
						t.fixMin || (e[0] = fw(Math.floor(e[0] / r) * r)),
							t.fixMax || (e[1] = fw(Math.ceil(e[1] / r) * r))
					}
				});
			pw.create = function () {
				return new pw
			...
			var gw = "__ec_stack_",
				vw = .5,
				mw = "undefined" != typeof Float32Array ? Float32Array : Array,
				yw = {
					seriesType: "bar",
					plan: S_(),
					reset: function (t) {
						function e(t, e) {
							for (var n, d = t.count,
								f = new mw(2 * d), p = new mw(2 * d), g = new mw(d), v = [], m = [], y = 0, _ = 0; null != (n = t.next());) m[h] = e.get(s, n),
									m[1 - h] = e.get(l, n),
				...
				Cw = pw.extend({
					...
					niceExtent: function (t) {
						var e = this._extent;
						if (e[0] === e[1] && (e[0] -= Iw, e[1] += Iw), e[1] === -1 / 0 && 1 / 0 === e[0]) {
							var n = new Date;
					...
					niceTicks: function (t, e, n) {
						...
						var d = this.getSetting("useUTC") ? 0 : 60 * new Date(+ i[0] || +i[1]).getTimezoneOffset() * 1e3,
							f = [Math.round(xw((i[0] - d) / u) * u + d), Math.round(ww((i[1] - d) / u) * u + d)];
						xh(f, i),
							this._stepLvl = l,
							this._interval = u,
							this._niceExtent = f
			...
			f(["contain", "normalize"],
				function (t) {
					Cw.prototype[t] = function (e) {
						return _w[t].call(this, this.parse(e))
					}
				});
			var Dw = [["hh:mm:ss", bw], ["hh:mm:ss", 5 * bw], ["hh:mm:ss", 10 * bw], ["hh:mm:ss", 15 * bw], ["hh:mm:ss", 30 * bw], ["hh:mm\nMM-dd", Sw], ["hh:mm\nMM-dd", 5 * Sw], ["hh:mm\nMM-dd", 10 * Sw], ["hh:mm\nMM-dd", 15 * Sw], ["hh:mm\nMM-dd", 30 * Sw], ["hh:mm\nMM-dd", Mw], ["hh:mm\nMM-dd", 2 * Mw], ["hh:mm\nMM-dd", 6 * Mw], ["hh:mm\nMM-dd", 12 * Mw], ["MM-dd\nyyyy", Iw], ["MM-dd\nyyyy", 2 * Iw], ["MM-dd\nyyyy", 3 * Iw], ["MM-dd\nyyyy", 4 * Iw], ["MM-dd\nyyyy", 5 * Iw], ["MM-dd\nyyyy", 6 * Iw], ["week", 7 * Iw], ["MM-dd\nyyyy", 10 * Iw], ["week", 14 * Iw], ["week", 21 * Iw], ["month", 31 * Iw], ["week", 42 * Iw], ["month", 62 * Iw], ["week", 70 * Iw], ["quarter", 95 * Iw], ["month", 31 * Iw * 4], ["month", 31 * Iw * 5], ["half-year", 380 * Iw / 2], ["month", 31 * Iw * 8], ["month", 31 * Iw * 10], ["year", 380 * Iw]];
			Cw.create = function (t) {
				return new Cw({
				...
				Rw = fh.extend({
					...
					$constructor: function () {
						fh.apply(this, arguments),
							this._originalScale = new pw
					},
					getTicks: function (t) {
						var e = this._originalScale,
							n = this._extent,
							i = e.getExtent();
						return p(kw.getTicks.call(this, t),
							function (t) {
								var r = bo(Ew(this.base, t));
								return r = t === n[0] && e.__fixMin ? Lh(r, i[0]) : r,
									r = t === n[1] && e.__fixMax ? Lh(r, i[1]) : r
							},
							this)
					},
					getMinorTicks: kw.getMinorTicks,
					getLabel: kw.getLabel,
					scale: function (t) {
						return t = Aw.scale.call(this, t),
							Ew(this.base, t)
					},
					setExtent: function (t, e) {
						var n = this.base;
						t = zw(t) / zw(n),
							e = zw(e) / zw(n),
							kw.setExtent.call(this, t, e)
					},
					getExtent: function () {
						var t = this.base,
							e = Aw.getExtent.call(this);
						e[0] = Ew(t, e[0]),
							e[1] = Ew(t, e[1]);
					...
					niceTicks: function (t) {
						...
						if (!(1 / 0 === n || 0 >= n)) {
							...
							var a = [bo(Bw(e[0] / i) * i), bo(Ow(e[1] / i) * i)];
							this._interval = i,
								this._niceExtent = a
						}
					},
					niceExtent: function (t) {
						kw.niceExtent.call(this, t);
						var e = this._originalScale;
						e.__fixMin = t.fixMin,
							e.__fixMax = t.fixMax
					}
			...
			var Uw = pa({
				...
				buildPath: function (t, e, n) {
					...
					if ("none" !== i) {
						var r = Yw[i];
						r || (i = "rect", r = Yw[i]),
							Xw[i](e.x, e.y, e.width, e.height, r.shape),
					...
					t: for (var i = 0,
						r = n.length; r > i; i++) if ("polygon" === n[i].type) {
							var a = n[i].exterior,
								o = n[i].interiors;
							if (Kh(a, t[0], t[1])) {
								for (var s = 0; s < (o ? o.length : 0); s++) if (Kh(o[s])) continue t;
								return !0
							}
						}
					return !1
			...
			ob.categoryAxis = r({
				...
				ob.logAxis = s({
					...
					ob.valueAxis);
			var sb = ["value", "category", "time", "log"],
				lb = function (t, e, n, i) {
					f(sb,
						function (o) {
							e.extend({
						...
						Oy.registerSubTypeDefaulter(t + "Axis", _(n, t))
				},
				ub = Oy.extend({
					type: "cartesian2dAxis",
					axis: null,
					init: function () {
						ub.superApply(this, "init", arguments),
							this.resetRange()
					},
					mergeOption: function () {
						ub.superApply(this, "mergeOption", arguments),
							this.resetRange()
					},
					restoreData: function () {
						ub.superApply(this, "restoreData", arguments),
							this.resetRange()
					},
			...
			var cb = xc.prototype;
			cb.type = "grid",
				cb.axisPointerEnabled = !0,
				cb.getRect = function () {
					return this._rect
				},
				cb.update = function (t, e) {
					var n = this._axesMap;
				...
				cb.getCartesians = function () {
					return this._coordsList.slice()
				},
				cb.convertToPixel = function (t, e, n) {
					var i = this._findConvertTarget(t, e);
					return i.cartesian ? i.cartesian.dataToPoint(n) : i.axis ? i.axis.toGlobalCoord(i.axis.dataToCoord(n)) : null
				},
				cb.convertFromPixel = function (t, e, n) {
					var i = this._findConvertTarget(t, e);
					return i.cartesian ? i.cartesian.pointToData(n) : i.axis ? i.axis.coordToData(i.axis.toLocalCoord(n)) : null
				},
				cb._findConvertTarget = function (t, e) {
				...
				cb.containPoint = function (t) {
					var e = this._coordsList[0];
					return e ? e.containPoint(t) : void 0
				},
				cb._initCartesian = function (t, e) {
					function n(n) {
						return function (o, s) {
							if (_c(o, t, e)) {
								...
								"x" === n ? "top" !== l && "bottom" !== l && (l = i.bottom ? "top" : "bottom") : "left" !== l && "right" !== l && (l = i.left ? "right" : "left"),
									i[l] = !0;
								var u = new rb(n, zh(o), [0, 0], o.get("type"), l),
									h = "category" === u.type;
			...
			xc.create = function (t, e) {
				...
				xc.dimensions = xc.prototype.dimensions = mc.prototype.dimensions,
				Ss.register("cartesian2d", xc);
			var fb = x_.extend({
			...
			var pb = yv([["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["stroke", "barBorderColor"], ["lineWidth", "barBorderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"]]),
				gb = {
					...
					_renderNormal: function (t) {
						...
						i.diff(r).add(function (r) {
							...
							x ? Ja(x, {
								...
								s, o) : x = bb[a.type](o, m, e, s, !0, h),
								i.setItemGraphicEl(o, x),
								n.add(x),
								zc(x, i, o, v, m, t, e, "polar" === a.type)
						}).remove(function (t) {
							var e = r.getItemGraphicEl(t);
							"cartesian2d" === a.type ? e && Oc(t, s, e) : e && Bc(t, s, e)
						}).execute();
						var g = this._backgroundGroup || (this._backgroundGroup = new hg);
						g.removeAll();
			...
			var _b = Math.max,
				...
				wb = {
					cartesian2d: function (t, e) {
						...
						var r = _b(e.x, t.x),
							a = xb(e.x + e.width, t.x + t.width),
							o = _b(e.y, t.y),
							s = xb(e.y + e.height, t.y + t.height);
						e.x = r,
							e.y = o,
							e.width = a - r,
							e.height = s - o;
			...
			var Db = {
				...
				axisName: function () {
					...
					if (n) {
						var i, r = e.get("nameLocation"),
							...
							h = u[0] > u[1] ? -1 : 1,
							c = ["start" === r ? u[0] - h * l : "end" === r ? u[1] + h * l : (u[0] + u[1]) / 2, jc(r) ? t.labelOffset + a * l : 0],
							d = e.get("nameRotate");
						null != d && (d = d * Tb / 180);
						var f;
						jc(r) ? i = kb(t.rotation, null != d ? d : t.rotation, a) : (i = Xc(t, r, d || 0, u), f = t.axisNameAvailableWidth, null != f && (f = Math.abs(f / Math.sin(i.rotation)), !isFinite(f) && (f = null)));
						var p = s.getFont(),
							g = e.get("nameTruncate", !0) || {},
							v = g.ellipsis,
							m = D(t.nameTruncateMaxWidth, g.maxWidth, f),
							y = null != v && null != m ? Iy(n, m, p, v, {
								minChar: 2,
						...
						Wa(b.style, s, {
							...
							e.get("triggerEvent") && (b.eventData = Ab(e), b.eventData.targetType = "axisName", b.eventData.name = n),
				...
				Ab = Cb.makeAxisEventDataBase = function (t) {
					var e = {
				...
				kb = Cb.innerTextLayout = function (t, e, n) {
					var i, r, a = Do(e - t);
					return Ao(a) ? (r = n > 0 ? "top" : "bottom", i = "center") : Ao(a - Tb) ? (r = n > 0 ? "bottom" : "top", i = "center") : (r = "middle", i = a > 0 && Tb > a ? n > 0 ? "right" : "left" : n > 0 ? "left" : "right"),
					{
						rotation: a,
						textAlign: i,
						textVerticalAlign: r
				...
				Pb = Cb.isLabelSilent = function (t) {
					var e = t.get("tooltip");
				...
				Bb = Du({
					...
					render: function (t, e, n, i) {
						this.axisPointerClass && ad(t),
							Bb.superApply(this, "render", arguments),
							hd(this, t, e, n, i, !0)
					},
					...
					remove: function (t, e) {
						...
						n && n.remove(e),
							Bb.superApply(this, "remove", arguments)
					},
					dispose: function (t, e) {
						cd(this, e),
							Bb.superApply(this, "dispose", arguments)
					}
				}),
				Eb = [];
			...
			var zb = ["axisLine", "axisTickLabel", "axisName"],
				Rb = ["splitArea", "splitLine", "minorSplitLine"],
				Nb = Bb.extend({
					type: "cartesianAxis",
					...
					render: function (t, e, n, i) {
						...
						if (this._axisGroup = new hg, this.group.add(this._axisGroup), t.get("show")) {
							...
							f(zb, s.add, s),
								...
								Nb.superCall(this, "render", t, e, n, i)
						}
					},
					remove: function () {
						pd(this)
			...
			Nb.extend({
				...
				Du({
					...
					render: function (t) {
						this.group.removeAll(),
							t.get("show") && this.group.add(new Rm({
				...
				Su(Ix.VISUAL.LAYOUT, _(Dh, "bar")),
				Su(Ix.VISUAL.PROGRESSIVE_LAYOUT, yw),
				Mu({
					seriesType: "bar",
					reset: function (t) {
			...
			Fb._createSymbol = function (t, e, n, i, r) {
				...
				Fb.stopSymbolAnimation = function (t) {
					this.childAt(0).stopAnimation(t)
				},
				Fb.getSymbolPath = function () {
					return this.childAt(0)
				},
				Fb.getScale = function () {
					return this.childAt(0).scale
				},
				Fb.highlight = function () {
					this.childAt(0).trigger("emphasis")
				},
				Fb.downplay = function () {
					this.childAt(0).trigger("normal")
				},
				Fb.setZ = function (t, e) {
					var n = this.childAt(0);
					n.zlevel = t,
						n.z = e
				},
				Fb.setDraggable = function (t) {
					var e = this.childAt(0);
					e.draggable = t,
						e.cursor = t ? "move" : e.cursor
				},
				Fb.updateData = function (t, e, n) {
					this.silent = !1;
			...
			var Hb = ["itemStyle"],
				Gb = ["emphasis", "itemStyle"],
				Wb = ["label"],
				Xb = ["emphasis", "label"];
			Fb._updateCommon = function (t, e, n, i) {
				function r(e) {
				...
				if (!i || t.hasItemOption) {
					...
					u = m.getModel(Hb).getItemStyle(["color"]),
						h = m.getModel(Gb).getItemStyle(),
			...
			Yb.updateData = function (t, e) {
				...
				r || n.removeAll(),
					t.diff(r).add(function (i) {
						...
						var u = r.getItemGraphicEl(l),
							h = t.getItemLayout(s);
						return xd(t, h, s, e) ? (u ? (u.updateData(t, s, o), Ja(u, {
							position: h
						},
				...
				Yb.isPersistent = function () {
					return !0
				},
				Yb.updateLayout = function () {
					var t = this._data;
				...
				Yb.incrementalPrepareUpdate = function (t) {
					this._seriesScope = bd(t),
						this._data = null,
						this.group.removeAll()
				},
				Yb.incrementalUpdate = function (t, e, n) {
					function i(t) {
			...
			var Ub = function (t, e, n, i, r, a, o, s) {
				for (var l = Td(t, e), u = [], h = [], c = [], d = [], f = [], p = [], g = [], v = Sd(r, e, o), m = Sd(a, t, s), y = 0; y < l.length; y++) {
					...
					switch (_.cmd) {
						...
						case "-":
							var S = _.idx,
								M = t.getRawIndex(S);
							M !== S ? (u.push(t.getItemLayout(S)), h.push(a.dataToPoint([t.get(m.dataDimsForPoint[0], S), t.get(m.dataDimsForPoint[1], S)])), c.push(n[S]), d.push(Id(m, a, t, S)), g.push(M)) : x = !1
					}
				...
				tS = ta.extend({
					...
					buildPath: function (t, e) {
						...
						for (; r > i;) i += Dd(t, n, i, r, r, 1, a.min, a.max, e.smooth, e.smoothMonotone, e.connectNulls) + 1
					}
				}),
				eS = ta.extend({
					type: "ec-polygon",
			...
			ul.extend({
				...
				render: function (t, e, n) {
					...
					i && i.getArea && t.get("clip", !0) && (M = i.getArea(), null != M.width ? (M.x -= .1, M.y -= .1, M.width += .2, M.height += .2) : M.r0 && (M.r0 -= .5, M.r1 += .5)),
						...
						f && c.type === i.type && I === this._step ? (m && !p ? p = this._newPolygon(u, x, i, v) : p && !m && (g.remove(p), p = this._polygon = null), g.setClipPath(Fd(i, !1, t)), w && d.updateData(a, {
							isIgnore: b,
							clipShape: M
						}), a.eachItemGraphicEl(function (t) {
							t.stopAnimation(!0)
						}), Ld(this._stackedOnPoints, x) && Ld(this._points, u) || (v ? this._updateAnimation(a, x, i, n, I, y) : (I && (u = Ed(u, i, I), x = Ed(x, i, I)), f.setShape({
							points: u
						}), p && p.setShape({
							points: u,
							stackedOnPoints: x
							...
							isIgnore: b,
							clipShape: M
						}), I && (u = Ed(u, i, I), x = Ed(x, i, I)), f = this._newPolyline(u, i, v), m && (p = this._newPolygon(u, x, i, v)), g.setClipPath(Fd(i, !0, t)));
				...
				highlight: function (t, e, n, i) {
					...
					if (!(a instanceof Array) && null != a && a >= 0) {
						...
						o.highlight()
					} else ul.prototype.highlight.call(this, t, e, n, i)
				},
				downplay: function (t, e, n, i) {
					var r = t.getData(),
						a = sr(r, i);
					...
					} else ul.prototype.downplay.call(this, t, e, n, i)
				},
				...
				_updateAnimation: function (t, e, n, i, r, a) {
					var o = this._polyline,
						s = this._polygon,
						l = t.hostModel,
						u = Ub(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, a),
						h = u.current,
					...
					return {
						...
						reset: function (t) {
							...
							if ("cartesian2d" === i.type && n) {
								...
								if (l > 1) {
									var u;
									"string" == typeof n ? u = rS[n] : "function" == typeof n && (u = n),
										u && t.setData(e.downSample(e.mapDimension(a.dim), 1 / l, u, aS))
								}
							}
						}
					}
				};
			Mu(nS("line", "circle", "line")),
				Su(iS("line")),
				yu(Ix.PROCESSOR.STATISTIC, oS("line"));
			var sS = function (t, e, n) {
				...
				uS = Au({
					...
					getDataParams: function (t) {
						var e = this.getData(),
							n = uS.superCall(this, "getDataParams", t),
							i = [];
			...
			hS.updateData = function (t, e, n) {
				...
				g && i.attr("cursor", g),
					Gd(this, t.getItemLayout(e), l.isSelected(t.getName(e)), l.get("selectedOffset"), l.get("animation"));
				var v = !n && "transition" === d;
				this._updateLabel(t, e, v),
					this.highDownOnUpdate = u.get("hoverAnimation") && l.isAnimationEnabled() ?
						function (t, e) {
				...
				hS._updateLabel = function (t, e, n) {
			...
			var cS = (ul.extend({
				...
				fS = Math.PI / 180,
				pS = function (t, e, n, i, r, a) {
					var o, s, l = t.getData(),
						u = [],
						h = !1,
						c = (t.get("minShowLabelAngle") || 0) * fS;
					l.each(function (i) {
						...
						!h && t.get("avoidLabelOverlap") && Yd(u, o, s, e, n, i, r, a)
				},
				gS = 2 * Math.PI,
				vS = Math.PI / 180,
				mS = function (t, e, n) {
					e.eachSeriesByType(t,
						function (t) {
							...
							pS(t, f, r.width, r.height, r.x, r.y)
						})
				},
				yS = function (t) {
					return {
			...
			var _S = L_.legend.selector,
				...
				wS = Cu({
					...
					mergeOption: function (t) {
						wS.superCall(this, "mergeOption", t),
							this._updateSelector(t)
					},
			...
			xu("legendToggleSelect", "legendselectchanged", _(jd, "toggleSelected")),
				xu("legendAllSelect", "legendselectall", _(jd, "allSelect")),
				xu("legendInverseSelect", "legendinverseselect", _(jd, "inverseSelect")),
				xu("legendSelect", "legendselected", _(jd, "select")),
				xu("legendUnSelect", "legendunselected", _(jd, "unSelect"));
			var bS = _,
				SS = f,
				MS = hg,
				IS = Du({
					...
					render: function (t, e, n) {
						...
						if (this._isFirstRender = !1, this.resetInner(), t.get("show", !0)) {
							...
							this.group.attr("position", [p.x - f.x, p.y - f.y]),
								this.group.add(this._backgroundEl = Zd(f, t))
						}
					},
					resetInner: function () {
							...
							SS(e.getData(),
								function (r, a) {
									...
									if (!l.get(o)) if (c) {
										...
										m.on("click", bS($d, o, null, i, h)).on("mouseover", bS(Qd, c.name, null, i, h)).on("mouseout", bS(Jd, c.name, null, i, h)),
											l.set(o, !0)
										...
										if (!l.get(o) && n.legendVisualProvider) {
											...
											g.on("click", bS($d, null, o, i, h)).on("mouseover", bS(Qd, null, o, i, h)).on("mouseout", bS(Jd, null, o, i, h)),
												l.set(o, !0)
										}
									},
										this)
					...
					layoutInner: function (t, e, n, i, r, a) {
						...
						ky(t.get("orient"), o, t.get("itemGap"), n.width, n.height);
						var l = o.getBoundingRect(),
							u = [- l.x, -l.y];
						if (r) {
							ky("horizontal", s, t.get("selectorItemGap", !0));
			...
			yu(Ix.PROCESSOR.SERIES_FILTER, TS),
				Oy.registerSubTypeDefaulter("legend",
					function () {
						return "plain"
					});
			var CS = wS.extend({
				...
				init: function (t, e, n, i) {
					var r = $o(t);
					CS.superCall(this, "init", t, e, n, i),
						tf(this, t, r)
				},
				mergeOption: function (t, e) {
					CS.superCall(this, "mergeOption", t, e),
						tf(this, this.option, t)
				}
			}),
				DS = hg,
				AS = ["width", "height"],
				...
				PS = IS.extend({
					...
					newlineDisabled: !0,
					init: function () {
						PS.superCall(this, "init"),
							this._currentIndex = 0,
							this.group.add(this._containerGroup = new DS),
							this._containerGroup.add(this.getContentGroup()),
							this.group.add(this._controllerGroup = new DS),
							this._showController
					},
					resetInner: function () {
						PS.superCall(this, "resetInner"),
					...
					renderInner: function (t, e, n, i, r, a, o) {
						...
						var l = this;
						PS.superCall(this, "renderInner", t, e, n, i, r, a, o);
					...
					layoutInner: function (t, e, n, r, a, o) {
						var s = this.getSelectorGroup(),
							...
							c = AS[1 - l],
							d = kS[1 - l];
						a && ky("horizontal", s, t.get("selectorItemGap", !0));
					...
					_layoutContentAndController: function (t, e, n, i, r, a, o) {
						...
						ky(t.get("orient"), s, t.get("itemGap"), i ? n.width : null, i ? null : n.height),
							ky("horizontal", u, t.get("pageButtonItemGap", !0));
						var h = s.getBoundingRect(),
							c = u.getBoundingRect(),
			...
			var LS = function (t, e) {
							...
							function (t, e) {
								...
								n && !f[e] && OS(n.axesInfo,
									function (e, i) {
										...
										if (e !== t && r) {
											var a = r.value;
											n.mapper && (a = t.axis.scale.parse(n.mapper(a, hf(e), hf(t)))),
												v[t.key] = a
										}
									})
							}),
				...
				FS = Du({
					...
					remove: function (t, e) {
						yf(e.getZr(), "axisPointer"),
							FS.superApply(this._model, "remove", arguments)
					},
					dispose: function (t, e) {
						yf("axisPointer", e),
							FS.superApply(this._model, "dispose", arguments)
					}
				}),
				VS = lr(),
				HS = i,
			...
			_f.prototype = {
				...
				createPointerEl: function (t, e) {
					var n = e.pointer;
					if (n) {
						var i = VS(t).pointerEl = new ly[n.type](HS(e.pointer));
						t.add(i)
					}
				},
				createLabelEl: function (t, e, n, i) {
					if (e.label) {
						var r = VS(t).labelEl = new Rm(HS(e.label));
						t.add(r),
							bf(r, i)
					}
				},
				updatePointerEl: function (t, e, n) {
					var i = VS(t).pointerEl;
				...
				_renderHandle: function (t) {
					if (!this._dragging && this.updateHandleTransform) {
						...
						this._handle || (o = !0, i = this._handle = so(r.get("icon"), {
							...
							onmousedown: GS(this._onHandleDragMove, this, 0, 0),
							drift: GS(this._onHandleDragMove, this),
							ondragend: GS(this._onHandleDragEnd, this)
						}), n.add(i)),
							Mf(i, e, !1);
				...
				_moveHandleToValue: function (t, e) {
					xf(this._axisPointerModel, !e && this._moveAnimation, this._handle, Sf(this.getHandleTransform(t, this._axisModel, this._axisPointerModel)))
				},
				_onHandleDragMove: function (t, e) {
					var n = this._handle;
					if (n) {
						this._dragging = !0;
						var i = this.updateHandleTransform(Sf(n), [t, e], this._axisModel, this._axisPointerModel);
						this._payloadInfo = i,
							n.stopAnimation(),
							n.attr(Sf(i)),
							VS(n).lastProp = null,
			...
			var WS = _f.extend({
				makeElOption: function (t, e, n, i, r) {
					var a = n.axis,
						o = a.grid,
						s = i.get("type"),
						l = Of(o, a).getOtherAxis(a).getGlobalExtent(),
				...
				updateHandleTransform: function (t, e, n) {
					var i = n.axis,
						...
						o = Of(r, i).getOtherAxis(i).getGlobalExtent(),
						s = "x" === i.dim ? 0 : 1,
						l = t.position;
					l[s] += e[s],
				...
				XS = {
					...
					shadow: function (t, e, n) {
						...
						return {
							type: "Rect",
							shape: Lf([e - i / 2, n[0]], [i, r], Bf(t))
						}
					}
				};
			Bb.registerAxisPointerClass("CartesianAxisPointer", WS),
				mu(function (t) {
					if (t) {
			...
			var YS = f,
				US = No,
				qS = ["", "-webkit-", "-moz-", "-o-"],
				jS = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;";
			Ff.prototype = {
				constructor: Ff,
				_enterable: !0,
				update: function () {
				...
				show: function (t) {
					...
					var e = this.el,
						n = this._styleCoord;
					e.style.cssText = jS + Rf(t) + ";left:" + n[0] + "px;top:" + n[1] + "px;" + (t.get("extraCssText") || ""),
				...
				moveTo: function (t, e) {
					...
					Nf(n, this._zr, this._appendToBody, t, e);
					var i = this.el.style;
					i.left = n[0] + "px",
						i.top = n[1] + "px"
				},
			...
			Du({
				...
				init: function (t, e) {
					if (!Kf.node) {
						...
						var r;
						"html" === this._renderMode ? (r = new Ff(e.getDom(), e, {
							appendToBody: n.get("appendToBody", !0)
						}), this._newLine = "<br/>") : (r = new Vf(e), this._newLine = "\n"),
				...
				_initGlobalListener: function () {
					var t = this._tooltipModel,
						e = t.get("triggerOn");
					df("itemTooltip", this._api, ZS(function (t, n, i) {
				...
				manuallyHideTip: function (t, e, n, i) {
					var r = this._tooltipContent; !this._alwaysShowContent && this._tooltipModel && r.hideLater(this._tooltipModel.get("hideDelay")),
						...
						i.from !== this.uid && this._hide(Gf(i, n))
				},
				_manuallyAxisShowTip: function (t, e, n, i) {
					...
					if (null != r && null != a && null != o) {
						...
						if (s) {
							var l = s.getData(),
								t = Hf([l.getItemModel(a), s, (s.coordinateSystem || {}).model, t]);
							...
							KS(t.dataByAxis,
								function (t) {
									var e = n.getComponent(t.axisDim + "Axis", t.axisIndex),
										...
										a = [];
									if (e && null != i) {
										var l = Df(i, e.axis, n, t.seriesDataIndices, t.valueLabelOpt);
				...
				_showSeriesItemTooltip: function (t, e, n) {
					var i = this._ecModel,
						...
						l = e.dataType,
						u = o.getData(),
						h = Hf([u.getItemModel(s), o, a && (a.coordinateSystem || {}).model, this._tooltipModel]),
						c = h.get("trigger");
					if (null == c || "item" === c) {
				...
				_updatePosition: function (t, e, n, i, r, a, o) {
					...
					if (o && d.applyTransform(o.transform), "function" == typeof e && (e = e([n, i], a, r.el, d, {
						...
						var p = Wf(n, i, r, s, l, h ? null : 20, c ? null : 20);
						n = p[0],
							i = p[1]
					}
					if (h && (n -= Uf(h) ? u[0] / 2 : "right" === h ? u[0] : 0), c && (i -= Uf(c) ? u[1] / 2 : "bottom" === c ? u[1] : 0), t.get("confine")) {
						var p = Xf(n, i, r, s, l);
						n = p[0],
							i = p[1]
					}
				...
				dispose: function (t, e) {
					Kf.node || (this._tooltipContent.dispose(), yf("itemTooltip", e))
				}
			}),
				xu({
					type: "showTip",
